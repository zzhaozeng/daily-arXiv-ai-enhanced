...
### [89] [Geometry-aware 4D Video Generation for Robot Manipulation](https://arxiv.org/abs/2507.01099)
*Zeyi Liu,Shuang Li,Eric Cousineau,Siyuan Feng,Benjamin Burchfiel,Shuran Song*
...
<details>
  <summary>Details</summary>
Motivation: 增强机器人在复杂环境中的规划和交互能力，解决现有视频生成模型在多视角几何一致性上的不足。

Method: 利用跨视角点图对齐监督训练模型，学习共享3D场景表示，仅需RGB-D观测即可预测未来视频序列。

Result: 在模拟和真实机器人数据集中，生成更稳定、空间对齐的视频预测，并支持机器人末端轨迹恢复。

Conclusion: 该方法在多视角一致性和机器人操作任务中表现出色，具有实际应用潜力。
...
### [90] [Landslide Detection and Mapping Using Deep Learning Across Multi-Source Satellite Data and Geographic Regions](https://arxiv.org/abs/2507.01123)
*Rahul A. Burange,Harsh K. Shinde,Omkar Mutyalwar*
...
Method: 利用Sentinel-2多光谱数据和ALOS PALSAR衍生的坡度及DEM层，结合多种地理空间分析技术和深度学习模型（如U-Net、DeepLabV3+和Res-Net）。

Result: 研究结果为开发可靠的早期预警系统、改进灾害风险管理和可持续土地利用规划提供了有价值的见解。

Conclusion: 深度学习和多源遥感在构建稳健、可扩展和可迁移的滑坡预测模型中具有巨大潜力。
...
### [91] [cp_measure: API-first feature extraction for image-based profiling workflows](https://arxiv.org/abs/2507.01163)
*Alán F. Muñoz,Tim Treis,Alexandr A. Kalinin,Shatavisha Dasgupta,Fabian Theis,Anne E. Carpenter,Shantanu Singh*
...
### [92] [Rapid Salient Object Detection with Difference Convolutional Neural Networks](https://arxiv.org/abs/2507.01182)
*Zhuo Su,Li Liu,Matthias Müller,Jiehua Zhang,Diana Wofk,Ming-Ming Cheng,Matti Pietikäinen*
...
Method: 结合传统SOD方法和现代CNN，使用PDCs编码特征对比，引入DCR策略减少推理计算量，提出STDC用于视频SOD。

Result: SDNet和STDNet在Jetson Orin设备上分别以46 FPS和150 FPS运行，参数少于1M，速度和精度均优于其他轻量模型。
...
### [93] [Robust Brain Tumor Segmentation with Incomplete MRI Modalities Using Hölder Divergence and Mutual Information-Enhanced Knowledge Transfer](https://arxiv.org/abs/2507.01254)
*Runze Cheng,Xihang Qiu,Ming Li,Ye Zhang,Chun Li,Fei Yu*
...
### [94] [AIGVE-MACS: Unified Multi-Aspect Commenting and Scoring Model for AI-Generated Video Evaluation](https://arxiv.org/abs/2507.01255)
*Xiao Liu,Jiawei Zhang*
...
<details>
  <summary>Details</summary>
Motivation: 现有AI生成视频评估指标缺乏解释性，难以与人类评价对齐，需要更全面的评估框架。

Method: 结合视觉语言模型、加权损失和动态帧采样策略，构建AIGVE-BENCH 2基准数据集。

Result: AIGVE-MACS在评分相关性和评论质量上达到最优，并通过多代理框架提升视频生成质量53.5%。
...
### [95] [Advancements in Weed Mapping: A Systematic Review](https://arxiv.org/abs/2507.01269)
*Mohammad Jahanbakht,Alex Olsen,Ross Marchant,Emilie Fillols,Mostafa Rahimi Azghadi*

Main category: cs.CV

TL;DR: 本文综述了杂草测绘的最新方法，填补了从数据采集到处理技术的全面文献空白，为未来研究提供参考。


<details>
  <summary>Details</summary>
Motivation: 杂草测绘对精准管理至关重要，但缺乏全面文献综述，限制了领域进展。

Method: 系统分析数据采集、处理及测绘技术，遵循PRISMA指南评估文献。

Result: 综述提供了杂草测绘领域的整体理解，支持高效、可持续的杂草管理系统开发。

Conclusion: 本文为未来杂草测绘研究和可持续管理系统的开发奠定了基础。
...
### [96] [DiffusionLight-Turbo: Accelerated Light Probes for Free via Single-Pass Chrome Ball Inpainting](https://arxiv.org/abs/2507.01305)
*Worameth Chinchuthakun,Pakkapon Phongthawee,Amit Raj,Varun Jampani,Pramook Khungurn,Supasorn Suwajanakorn*

Main category: cs.CV

TL;DR: 提出了一种通过将任务重新定义为镀铬球修复问题，从单张低动态范围（LDR）图像估计光照的简单有效技术。利用预训练扩散模型Stable Diffusion XL，克服了依赖有限HDR全景数据集方法的泛化失败问题。


<details>
  <summary>Details</summary>
Motivation: 现有方法依赖有限HDR数据集，泛化能力不足。扩散模型在生成镀铬球时存在内容不一致或错误的问题，且无法直接生成HDR格式。

Method: 提出DiffusionLight，通过迭代修复计算中位镀铬球作为稳定低频光照先验，指导生成高质量结果。进一步提出DiffusionLight-Turbo，通过训练Turbo LoRA直接预测迭代过程的平均镀铬球，将运行时间从30分钟缩短至30秒。

Result: 实验结果表明，该方法在多样化场景中生成逼真的光照估计，并在真实场景中表现出优越的泛化能力。

Conclusion: DiffusionLight和DiffusionLight-Turbo通过创新技术显著提升了光照估计的效率和质量，适用于广泛场景。
...
### [97] [Frequency Domain-Based Diffusion Model for Unpaired Image Dehazing](https://arxiv.org/abs/2507.01275)
*Chengxu Liu,Lu Qi,Jinshan Pan,Xueming Qian,Ming-Hsuan Yang*
...
Conclusion: \ours 通过频域建模有效解决了无配对去雾问题。
...
### [98] [Tile and Slide : A New Framework for Scaling NeRF from Local to Global 3D Earth Observation](https://arxiv.org/abs/2507.01631)
*Camille Billouard,Dawa Derksen,Alexandre Constantin,Bruno Vallet*

Main category: cs.CV

TL;DR: Snake-NeRF是一种扩展到大场景的NeRF框架，通过分块处理和重叠裁剪图像，解决了内存限制问题，实现了单设备上的高效3D重建。
...
Method: 提出Snake-NeRF框架，采用分块处理、重叠裁剪图像、2×2 3D瓦片渐进策略和分段采样器。
...
### [99] [Learning an Ensemble Token from Task-driven Priors in Facial Analysis](https://arxiv.org/abs/2507.01290)
*Sunyong Seo,Semin Kim,Jongha Lee*
...
<details>
  <summary>Details</summary>
Motivation: 现有方法在面部分析任务中未能统一单任务学习的特征表示，ET-Fuser旨在解决这一问题。

Method: 利用预训练模型的任务先验，通过自注意力机制生成集成令牌，共享预训练编码器的互信息。

Result: 在多种面部分析任务中表现出显著的特征表示改进，且计算成本极低。

Conclusion: ET-Fuser通过集成令牌方法高效地统一了特征表示，提升了面部分析任务的性能。
...
### [100] [Physics-informed Ground Reaction Dynamics from Human Motion Capture](https://arxiv.org/abs/2507.01340)
*Cuong Le,Huy-Phuong Le,Duc Le,Minh-Thien Duong,Van-Binh Nguyen,My-Ha Le*
...
Conclusion: 提出的方法通过物理约束提高了估计精度，且无需依赖力板设备，扩展了应用场景。
...
### [101] [Learning Camera-Agnostic White-Balance Preferences](https://arxiv.org/abs/2507.01342)
*Luxi Zhao,Mahmoud Afifi,Michael S. Brown*

Main category: cs.CV

TL;DR: 该论文提出了一种轻量级方法，通过学习后照明估计映射，将中性白平衡校正转换为美学偏好校正，实现跨相机的一致性和风格化色彩渲染。


<details>
  <summary>Details</summary>
Motivation: 商业自动白平衡（AWB）系统通常追求美学偏好而非准确的中性色彩校正，且现有学习型方法难以泛化到不同相机传感器。

Method: 提出一种后照明估计映射，将中性白平衡校正转换为美学偏好校正，模型轻量（约500参数），计算高效（0.024毫秒）。

Result: 在771张智能手机图像数据集上，该方法实现了最先进的性能，且与现有跨相机AWB技术完全兼容。

Conclusion: 该方法首次解决了美学一致性问题，为跨相机风格化色彩渲染提供了高效解决方案。
...
### [102] [Learning from Random Subspace Exploration: Generalized Test-Time Augmentation with Self-supervised Distillation](https://arxiv.org/abs/2507.01347)
*Andrei Jelea,Ahmed Nabil Belbachir,Marius Leordeanu*
...
Method: 通过随机扰动PCA子空间投影形成集成，并引入自监督学习阶段，用集成输出训练初始模型。

Result: 在多种任务和数据集上验证了GTTA的通用性和有效性，包括特定任务如低能见度水下视频中的鲑鱼分割。
...
### [103] [Long-Tailed Distribution-Aware Router For Mixture-of-Experts in Large Vision-Language Model](https://arxiv.org/abs/2507.01351)
*Chaoxiang Cai,Longrong Yang,Kaibing Chen,Fan Yang,Xi Li*

Main category: cs.CV

TL;DR: 论文提出了一种长尾分布感知路由器（LTDR），用于解决视觉语言混合专家（MoE）模型中模态间分布差异的问题，通过针对性的路由策略和专家激活增强，提升了性能。


<details>
  <summary>Details</summary>
Motivation: 现有MoE框架在处理视觉语言模型时忽略了视觉和语言模态间的分布差异，导致路由策略不够优化。

Method: 提出LTDR，包括针对模态的分布感知路由策略和对视觉尾部令牌的专家激活增强。

Result: 在多个基准测试中验证了LTDR的有效性。

Conclusion: LTDR通过考虑模态间分布差异和优化专家激活，显著提升了视觉语言MoE模型的性能。
...
TL;DR: 提出了一种基于3D高斯散射（3DGS）的物理攻击框架PGA，通过快速精确的3D重建和真实感渲染，提升了对抗伪装的多视角鲁棒性和有效性。


<details>
  <summary>Details</summary>
Motivation: 现有基于伪装的物理攻击方法依赖目标对象的网格先验和模拟器构建的虚拟环境，耗时且与真实世界存在差异，且缺乏多视角鲁棒性。

Method: 利用3DGS进行快速精确的3D重建，通过防止高斯间的相互遮挡和自遮挡，采用min-max优化调整每个视角的背景，过滤非鲁棒对抗特征。

Result: 实验验证了PGA在对抗有效性和多视角鲁棒性上的优越性。

Conclusion: PGA框架显著提升了物理攻击的对抗效果和鲁棒性，适用于复杂物理环境。
...
### [105] [Activation Reward Models for Few-Shot Model Alignment](https://arxiv.org/abs/2507.01368)
*Tianning Chai,Chancharik Mitra,Brandon Huang,Gautam Rajendrakumar Gare,Zhiqiu Lin,Assaf Arbelle,Leonid Karlinsky,Rogerio Feris,Trevor Darrell,Deva Ramanan,Roei Herzig*

Main category: cs.CV

TL;DR: 提出了一种新的少样本奖励建模方法（Activation RMs），利用激活导向生成奖励信号，无需额外微调，性能优于现有方法，并在防止奖励攻击行为上表现优异。


<details>
  <summary>Details</summary>
Motivation: 传统奖励建模难以适应新偏好，需单独训练奖励模型且依赖大数据集。

Method: 提出Activation RMs，通过激活导向构建奖励信号，仅需少量监督且无需额外微调。

Result: 在标准奖励建模基准上优于现有少样本方法，并在新提出的PreferenceHack基准上表现最佳。

Conclusion: Activation RMs是一种高效且安全的奖励建模方法，适用于实际应用。
...
### [106] [Active Measurement: Efficient Estimation at Scale](https://arxiv.org/abs/2507.01372)
*Max Hamilton,Jinlin Lai,Wenlong Zhao,Subhransu Maji,Daniel Sheldon*

Main category: cs.CV

TL;DR: 提出了一种名为“主动测量”的人机协作AI框架，用于科学测量，通过重要性采样和蒙特卡洛估计提高测量精度。
...
Method: 结合AI模型预测和人类标注，采用重要性采样优化样本选择，并通过迭代改进模型和估计。

Result: 主动测量在多个测量任务中减少了估计误差，且对AI模型的不完美性具有鲁棒性。

Conclusion: 主动测量为科学测量提供了一种高效且精确的解决方案，尤其适用于需要统计保证的场景。
...
### [107] [MUG: Pseudo Labeling Augmented Audio-Visual Mamba Network for Audio-Visual Video Parsing](https://arxiv.org/abs/2507.01384)
*Langyu Wang,Bingke Zhu,Yingying Chen,Yiyuan Zhang,Ming Tang,Jinqiao Wang*

Main category: cs.CV

TL;DR: 提出了一种基于伪标签增强的音频-视觉Mamba网络（MUG），用于改进弱监督音频-视觉视频解析任务，显著提升了段级和事件级预测性能。
...
Method: 通过伪标签增强生成新数据，并利用音频-视觉Mamba网络（AV-Mamba）处理特征和模态交互，以增强段级事件解析能力并排除噪声干扰。

Result: 在LLP数据集上，MUG在所有指标上均优于现有方法，视觉段级和音频段级指标分别提升2.1%和1.2%。
...
### [108] [FixTalk: Taming Identity Leakage for High-Quality Talking Head Generation in Extreme Cases](https://arxiv.org/abs/2507.01390)
*Shuai Tan,Bill Gong,Bin Ji,Ye Pan*
...
Result: 实验证明FixTalk有效缓解问题，性能优于现有方法。
...
### [109] [Coherent Online Road Topology Estimation and Reasoning with Standard-Definition Maps](https://arxiv.org/abs/2507.01397)
*Khanh Son Pham,Christian Witte,Jens Behley,Johannes Betz,Cyrill Stachniss*

Main category: cs.CV

TL;DR: 论文提出了一种利用标准地图（SD）信息预测车道段及其拓扑结构和道路边界的方法，通过混合编码和去噪技术提升性能。
...
Conclusion: 通过建模方案和混合编码，实现了更优的车道和道路边界预测。
...
### [110] [Medical-Knowledge Driven Multiple Instance Learning for Classifying Severe Abdominal Anomalies on Prenatal Ultrasound](https://arxiv.org/abs/2507.01401)
*Huanwen Liang,Jingxian Xu,Yuanji Zhang,Yuhao Huang,Yuhan Zhang,Xin Yang,Ran Li,Xuedong Deng,Yanjun Liu,Guowei Tao,Yun Wu,Sheng Zhao,Xinru Gao,Dong Ni*

Main category: cs.CV

TL;DR: 提出了一种基于多实例学习的病例级方法，用于胎儿腹部异常的产前超声分类，无需标准平面定位，性能优于现有方法。


<details>
  <summary>Details</summary>
Motivation: 胎儿腹部畸形是严重的先天异常，需要准确诊断以指导妊娠管理和降低死亡率。AI在医学诊断中潜力巨大，但产前腹部异常的应用仍有限。

Method: 采用混合注意力专家模块（MoAE）加权不同平面的注意力头；提出医学知识驱动的特征选择模块（MFS）进行自监督图像标记选择；提出基于提示的原型学习（PPL）增强MFS。

Result: 在大规模产前腹部超声数据集（2,419病例，24,748图像，6类别）上验证，性能优于现有方法。
...
### [111] [DocShaDiffusion: Diffusion Model in Latent Space for Document Image Shadow Removal](https://arxiv.org/abs/2507.01422)
*Wenjie Liu,Bingshu Wang,Ze Wang,C. L. Philip Chen*
...
<details>
  <summary>Details</summary>
Motivation: 现有方法通常仅处理恒定颜色背景的阴影，而忽略了彩色阴影，因此需要一种更有效的阴影去除方法。

Method: 通过潜在空间扩散模型（DocShaDiffusion）将阴影图像从像素空间转换到潜在空间，并设计SSGM生成精确阴影掩模，SMGDM引导扩散和去噪过程。还提出阴影鲁棒感知特征损失以保留细节。
...
### [112] [CaptionSmiths: Flexibly Controlling Language Pattern in Image Captioning](https://arxiv.org/abs/2507.01409)
*Kuniaki Saito,Donghyun Kim,Kwanyong Park,Atsushi Hashimoto,Yoshitaka Ushiku*

Main category: cs.CV

TL;DR: 提出了一种名为CaptionSmiths的新方法，通过量化标题的长度、描述性和独特性，实现单一模型对多样化语言模式的灵活控制。


<details>
  <summary>Details</summary>
Motivation: 现有图像标题生成模型难以精细控制生成标题的属性，如长度和描述性，且无法平滑过渡语言模式。

Method: 量化标题的三个属性为连续标量值，并通过端点向量插值实现条件控制。

Result: 模型能平滑调整输出标题属性，词汇对齐性优于基线，长度控制误差减少506%。

Conclusion: CaptionSmiths成功实现了对标题属性的灵活控制，具有更高的实用性和性能。
...
### [113] [NOCTIS: Novel Object Cyclic Threshold based Instance Segmentation](https://arxiv.org/abs/2507.01463)
*Max Gandyra,Alessandro Santonicola,Michael Beetz*

Main category: cs.CV

TL;DR: NOCTIS是一种无需重新训练即可对未见物体进行实例分割的框架，结合Grounded-SAM 2和DINOv2，在BOP 2023挑战中表现优异。
...
Conclusion: NOCTIS通过结合先进模型和优化匹配策略，实现了对未见物体的高效实例分割。
...
### [114] [Gradient Short-Circuit: Efficient Out-of-Distribution Detection via Feature Intervention](https://arxiv.org/abs/2507.01417)
*Jiawei Gu,Ziyue Qiao,Zechao Li*

Main category: cs.CV

TL;DR: 提出一种基于梯度方向的OOD检测方法，通过短路异常梯度提升检测效果，无需额外计算开销。


<details>
  <summary>Details</summary>
Motivation: 在开放世界中，OOD检测对模型安全部署至关重要。观察到ID样本梯度方向一致，而OOD样本梯度方向混乱，启发利用这一现象改进检测。

Method: 提出推理阶段技术，短路异常梯度特征坐标，同时保留ID分类能力；引入局部一阶近似避免二次前向计算。
...
### [115] [Crop Pest Classification Using Deep Learning Techniques: A Review](https://arxiv.org/abs/2507.01494)
*Muhammad Hassam Ejaz,Muhammad Bilal,Usman Habib*

Main category: cs.CV

TL;DR: 综述分析了2018-2025年间37项关于AI在害虫分类中的应用研究，重点探讨了模型架构、数据集和技术挑战。
...
Result: 早期研究多依赖CNN，近年转向混合和Transformer模型，但数据不平衡、小害虫检测等问题仍存。

Conclusion: 综述总结了AI害虫监测的现状、数据集和未来方向，为研究提供参考。
...
### [116] [DiffMark: Diffusion-based Robust Watermark Against Deepfakes](https://arxiv.org/abs/2507.01428)
*Chen Sun,Haiyang Sun,Zhiqing Guo,Yunfeng Diao,Liejun Wang,Dan Ma,Gaobo Yang,Keqin Li*

Main category: cs.CV

TL;DR: DiffMark是一种基于扩散模型的鲁棒水印框架，通过改进训练和采样方案，结合人脸图像和水印条件生成水印图像，并通过对抗性指导增强对Deepfake操作的鲁棒性。


<details>
  <summary>Details</summary>
Motivation: Deepfake技术对安全和隐私构成威胁，现有水印方法对Deepfake操作的鲁棒性不足。扩散模型在图像生成中表现优异，可用于水印融合。

Method: 修改扩散模型的训练和采样方案，引入时间步依赖的权重因子和交叉信息融合模块（CIF），并集成冻结自编码器模拟Deepfake操作，结合对抗性指导生成鲁棒水印图像。
...
### [117] [Integrating Traditional and Deep Learning Methods to Detect Tree Crowns in Satellite Images](https://arxiv.org/abs/2507.01502)
*Ozan Durgut,Beril Kallfelz-Sirmacek,Cem Unsalan*
...
Method: 结合传统方法进行特征提取和分割，利用深度学习检测树冠，并通过规则化后处理优化结果。

Result: 提出的方法提高了检测到的树冠数量，并分析了其优缺点和改进方向。
...
### [118] [TurboReg: TurboClique for Robust and Efficient Point Cloud Registration](https://arxiv.org/abs/2507.01439)
*Shaocheng Yan,Pengcheng Shi,Zhenjun Zhao,Kaixin Wang,Kuang Cao,Ji Wu,Jiayuan Li*
...
<details>
  <summary>Details</summary>
Motivation: 现有基于最大团搜索的PCR方法虽召回率高，但时间复杂度过高，不适用于实时应用。

Method: 定义TurboClique为高约束兼容图中的3-团，结合PGS算法高效搜索高内点率匹配。

Result: TurboReg在多个数据集上达到SOTA性能，速度提升显著，如3DMatch+FCGF数据集上快208.22倍。

Conclusion: TurboReg通过轻量级设计和并行搜索，实现了高效鲁棒的PCR，适用于实时应用。
...
### [119] [Following the Clues: Experiments on Person Re-ID using Cross-Modal Intelligence](https://arxiv.org/abs/2507.01504)
*Robert Aufschläger,Youssef Shoeb,Azarm Nowzad,Michael Heigl,Fabian Bally,Martin Schramm*
...
<details>
  <summary>Details</summary>
Motivation: 街景数据作为开放数据对自动驾驶和AI研究至关重要，但存在隐私风险，尤其是行人PII泄露问题。

Method: 使用大型视觉语言模型、图注意力网络和表示学习，检测可描述的PII线索，并利用可解释特征提升Re-ID。

Result: 实验表明，该框架在跨数据集Re-ID任务中表现优异，特别是在Market-1501到CUHK03-np的数据集上。

Conclusion: cRID框架有效解决了PII检测和Re-ID问题，具有实际应用价值。
...
### [120] [OoDDINO:A Multi-level Framework for Anomaly Segmentation on Complex Road Scenes](https://arxiv.org/abs/2507.01455)
*Yuxing Liu,Ji Zhang,Zhou Xuchuan,Jingzhong Xiao,Huimin Yang,Jiaxin Zhong*

Main category: cs.CV

TL;DR: OoDDINO是一种新颖的多级异常分割框架，通过粗到细的检测策略解决现有像素级方法的局限性，结合不确定性引导的检测模型和像素级分割模型，提升异常分割效果。


<details>
  <summary>Details</summary>
Motivation: 现有像素级异常分割方法忽视像素间的空间相关性，且全局阈值策略导致误检或漏检，需改进。

Method: 提出OoDDINO框架，包含正交不确定性感知融合策略（OUAFS）和自适应双阈值网络（ADT-Net），分两阶段实现精细分割。

Result: 在多个基准数据集上验证，OoDDINO优于现有方法，兼容性强。

Conclusion: OoDDINO通过多级策略有效解决异常分割问题，具有实际应用潜力。
...
### [121] [Autonomous AI Surveillance: Multimodal Deep Learning for Cognitive and Behavioral Monitoring](https://arxiv.org/abs/2507.01590)
*Ameer Hamza,Zuhaib Hussain But,Umar Arif,Samiya,M. Abdullah Asad,Muhammad Naeem*

Main category: cs.CV

TL;DR: 该研究提出了一种多模态课堂监控系统，结合睡意检测、手机使用追踪和人脸识别，以高精度评估学生注意力。系统使用YOLOv8和LResNet Occ FC等技术，实现了实时监测，并展示了高准确率。


<details>
  <summary>Details</summary>
Motivation: 提升课堂监控的精确性和全面性，通过多模态技术实时评估学生注意力，同时实现自动考勤。

Method: 整合YOLOv8模型检测手机和睡意，LResNet Occ FC进行人脸识别，结合ESP32-CAM硬件和PHP框架实现实时数据采集与分析。

Result: 睡意检测mAP@50达97.42%，人脸识别准确率86.45%，手机检测mAP@50为85.89%。

Conclusion: 该系统为教育环境提供了一种高效、可扩展的监控方案，兼具注意力评估和自动考勤功能。
...
### [122] [Survivability of Backdoor Attacks on Unconstrained Face Recognition Systems](https://arxiv.org/abs/2507.01607)
*Quentin Le Roux,Yannick Teglia,Teddy Furon,Philippe Loubet-Moundi,Eric Bourbao*

Main category: cs.CV

TL;DR: 该论文首次系统研究了深度学习人脸识别系统中的后门攻击，展示了两种针对人脸检测任务的后门攻击，并验证了特征提取器同样易受攻击。通过20种管道配置和15种攻击案例，证明了单一后门可绕过系统功能，并提出了应对措施。


<details>
  <summary>Details</summary>
Motivation: 深度学习人脸识别广泛应用但存在安全隐患，尤其是针对现实场景的后门攻击研究不足。

Method: 研究后门攻击在人脸检测和特征提取任务中的可行性，设计两种攻击（人脸生成和关键点偏移），并测试多种管道配置。

Result: 验证了后门攻击的有效性，单一后门可绕过系统功能。

Conclusion: 提出了针对后门攻击的最佳实践和防御措施。
...
### [123] [Representation Entanglement for Generation:Training Diffusion Transformers Is Much Easier Than You Think](https://arxiv.org/abs/2507.01467)
*Ge Wu,Shen Zhang,Ruijing Shi,Shanghua Gao,Zhenyuan Chen,Lei Wang,Zhaowei Chen,Hongcheng Gao,Yao Tang,Jian Yang,Ming-Ming Cheng,Xiang Li*
...
Result: 在ImageNet 256×256上，REG显著加速了训练收敛，训练效率提升高达63倍，且生成质量优于现有方法。

Conclusion: REG通过语义知识的主动引导，提升了图像生成的效果和效率，且推理开销极小。
...
### [124] [Prompt Guidance and Human Proximal Perception for HOT Prediction with Regional Joint Loss](https://arxiv.org/abs/2507.01630)
*Yuxiao Wang,Yu Lei,Zhenao Wei,Weiying Xue,Xinyu Jiang,Nan Zhuang,Qi Liu*
...
<details>
  <summary>Details</summary>
Motivation: 当前HOT检测模型局限于单一图像类型，导致过度分割和区域类别不一致的问题，需要一种更有效的方法来提升性能。

Method: P3HOT框架结合语义驱动的提示机制和人类近端感知机制，动态感知关键深度范围，并引入区域联合损失（RJLoss）和新评估指标AD-Acc。

Result: 实验结果表明，P3HOT在多个指标上达到最先进水平，尤其在HOT-Annotated数据集上显著提升了性能。

Conclusion: P3HOT通过结合提示和深度感知，有效解决了HOT检测中的挑战，并在实验中验证了其优越性。
...
TL;DR: 论文提出了一种加速甲烷泄漏检测的方法，通过高效低功耗算法（如Mag1c-SAS和CEM）结合机器学习模型（U-Net、LinkNet），显著提升了计算速度，适用于星载硬件。


<details>
  <summary>Details</summary>
Motivation: 甲烷是强效温室气体，现有卫星任务依赖人工调度，效率低且易漏检。星载检测受限于硬件资源，传统方法计算量大，需开发高效低功耗算法。

Method: 测试快速目标检测方法（ACE、CEM），提出Mag1c-SAS（Mag1c的快速变体），结合机器学习模型（U-Net、LinkNet），并评估三种波段选择策略。

Result: Mag1c-SAS和CEM在强羽流检测中表现良好，计算速度分别提升约100倍和230倍。一种波段选择策略在减少通道的同时保持精度。

Conclusion: 研究为星载甲烷检测提供了高效低功耗解决方案，代码和数据已开源，推动及时数据交付。
...
### [126] [Active Control Points-based 6DoF Pose Tracking for Industrial Metal Objects](https://arxiv.org/abs/2507.01478)
*Chentao Shen,Ding Pan,Mingyu Mei,Zaixing He,Xinyue Zhao*
...
<details>
  <summary>Details</summary>
Motivation: 工业金属物体的位姿跟踪在真实环境中具有挑战性，主要因其反射特性。

Method: 使用图像控制点主动生成边缘特征进行优化，并引入最优控制点回归方法提高鲁棒性。

Result: 在数据集评估和真实任务中表现有效，适用于工业金属物体的实时跟踪。
...
### [127] [Depth Anything at Any Condition](https://arxiv.org/abs/2507.01634)
*Boyuan Sun,Modi Jin,Bowen Yin,Qibin Hou*

Main category: cs.CV

TL;DR: DepthAnything-AC是一种基础单目深度估计模型，能够在多样环境条件下工作，通过无监督一致性正则化微调范式和小量未标记数据提升性能。


<details>
  <summary>Details</summary>
Motivation: 现有基础MDE模型在复杂开放世界环境中表现不佳，如光照变化、恶劣天气和传感器失真等挑战性条件。

Method: 提出无监督一致性正则化微调范式，并引入空间距离约束以学习补丁级相对关系。

Result: 实验证明模型在多样化基准测试中具有零样本能力，包括真实恶劣天气、合成失真和通用场景。
...
### [128] [What Really Matters for Robust Multi-Sensor HD Map Construction?](https://arxiv.org/abs/2507.01484)
*Xiaoshuai Hao,Yuting Zhao,Yuheng Ji,Luanyuan Dai,Peng Hao,Dingzhe Li,Shuai Cheng,Rong Yin*

Main category: cs.CV

TL;DR: 论文提出了一种增强多模态融合方法鲁棒性的策略，用于高精地图构建，包括数据增强、新型多模态融合模块和模态丢弃训练策略，实验表明其显著提升了基线方法的鲁棒性和性能。


<details>
  <summary>Details</summary>
Motivation: 现有方法主要关注模型精度而忽视鲁棒性，而鲁棒性对自动驾驶的实际应用至关重要。

Method: 提出数据增强、新型多模态融合模块和模态丢弃训练策略。

Result: 在NuScenes数据集上显著提升基线方法的鲁棒性，并在干净验证集上达到最先进性能。

Conclusion: 研究为开发更鲁棒可靠的高精地图构建模型提供了有价值的见解，推动了其在自动驾驶中的应用。
...
### [129] [Autoregressive Image Generation with Linear Complexity: A Spatial-Aware Decay Perspective](https://arxiv.org/abs/2507.01652)
*Yuxin Mao,Zhen Qin,Jinxing Zhou,Hui Deng,Xuyang Shen,Bin Fan,Jing Zhang,Yiran Zhong,Yuchao Dai*

Main category: cs.CV

TL;DR: 提出了一种新型注意力机制LASAD，解决了线性注意力在图像生成中无法捕捉长距离依赖的问题，实现了高效的图像生成。


<details>
  <summary>Details</summary>
Motivation: 现有的自回归模型在图像生成中主要依赖Transformer架构，但其计算复杂度高且内存开销大，线性注意力机制在图像生成中效果不佳。

Method: 提出LASAD机制，通过基于真实2D空间位置的位置依赖衰减因子，保留空间关系，并构建了LASADGen模型。

Result: 在ImageNet上的实验表明，LASADGen在图像生成质量和计算效率上均达到最优。

Conclusion: LASADGen成功平衡了线性注意力的效率和高质量图像生成所需的空间理解能力。
...
TL;DR: AVC-DPO是一种后训练框架，通过偏好对齐增强视频MLLM的标题生成能力，专注于时空动态和空间信息，在VDC基准测试中表现优异。
...
Conclusion: AVC-DPO通过偏好对齐有效提升了视频标题生成的人类中心化能力。
...
<details>
  <summary>Details</summary>
Motivation: 探索下一代自动驾驶解决方案，解决极端场景问题。

Method: 邀请5位学术界和工业界专家分享最新进展，并举办双轨挑战赛（场景理解与生成）。

Result: 汇集研究成果，推动前沿技术与可靠自动驾驶的融合。

Conclusion: W-CODA将持续弥合技术差距，提升自动驾驶在极端场景下的可靠性。
...
<details>
  <summary>Details</summary>
Motivation: 尽管ReFlow在图像质量和文本对齐上优于扩散模型，但其在实时图像编辑中的应用仍具挑战性。

Method: 分析多模态Transformer块的中间表示，提取三个关键特征，利用中步潜在表示进行结构保留，并通过注意力调整提升编辑效果。

Result: 在两项基准测试中优于九种基线方法，用户评估显示用户偏好该方法。
...
### [133] [Are Vision Transformer Representations Semantically Meaningful? A Case Study in Medical Imaging](https://arxiv.org/abs/2507.01788)
*Montasir Shams,Chashi Mahiul Islam,Shaeke Salman,Phat Tran,Xiuwen Liu*

Main category: cs.CV

TL;DR: Vision transformers (ViTs)在医学影像任务中表现优异，但其表征缺乏语义意义且易受微小变化影响，导致分类结果不可靠。


<details>
  <summary>Details</summary>
Motivation: 探究ViTs在医学影像分类中的表征是否具有语义意义及其稳定性。

Method: 使用基于投影梯度的算法分析ViTs的表征。

Result: ViTs的表征缺乏语义意义，微小变化可导致分类准确率下降60%以上。

Conclusion: ViTs的表征在医学影像分类中存在根本性缺陷，可能影响其在安全关键系统中的部署。
...
### [134] [Mamba Guided Boundary Prior Matters: A New Perspective for Generalized Polyp Segmentation](https://arxiv.org/abs/2507.01509)
*Tapas K. Dutta,Snehashis Majhi,Deepak Ranjan Nayak,Debesh Jha*
...
Result: 在五个多样化数据集上表现优于现有方法，实现了更高的分割准确性和鲁棒性。

Conclusion: SAM-MaGuP为息肉分割领域设定了新标准，解决了弱边界挑战并提升了临床应用的实用性。
...
### [135] [Exploring Pose-based Sign Language Translation: Ablation Studies and Attention Insights](https://arxiv.org/abs/2507.01532)
*Tomas Zelezny,Jakub Straka,Vaclav Javorek,Ondrej Valach,Marek Hruz,Ivan Gruber*
...
<details>
  <summary>Details</summary>
Motivation: 研究如何通过姿态数据预处理技术提升手语翻译系统的性能，解决连续无注释翻译中的挑战。

Method: 采用改进的T5编码器-解码器模型处理姿态表示，并在YouTubeASL和How2Sign数据集上进行消融实验。

Result: 适当的归一化、插值和增强技术显著提高了模型的鲁棒性和泛化能力，专用寄存器标记可进一步提升性能。
...
### [136] [TrackingMiM: Efficient Mamba-in-Mamba Serialization for Real-time UAV Object Tracking](https://arxiv.org/abs/2507.01535)
*Bingxi Liu,Calvin Chen,Junhao Li,Guyang Yu,Haoqian Song,Xuchen Liu,Jinqiang Cui,Hong Zhang*
...
<details>
  <summary>Details</summary>
Motivation: Vision Transformer在无人机跟踪任务中因二次复杂度问题难以实时处理数据，Mamba模型的计算效率和长序列建模能力为解决这一问题提供了可能。

Method: 提出了TrackingMiM架构，采用嵌套的Mamba扫描机制，独立处理时空一致的图像块，同时将模板帧编码为查询令牌用于跟踪。

Result: 在五个无人机跟踪基准测试中，TrackingMiM实现了最先进的精度和显著更高的速度。

Conclusion: TrackingMiM通过Mamba-in-Mamba架构有效解决了时空一致性问题，为无人机跟踪任务提供了高效且精确的解决方案。
...
### [137] [A Multi-Centric Anthropomorphic 3D CT Phantom-Based Benchmark Dataset for Harmonization](https://arxiv.org/abs/2507.01539)
*Mohammadreza Amirian,Michael Bach,Oscar Jimenez-del-Toro,Christoph Aberle,Roger Schaer,Vincent Andrearczyk,Jean-Félix Maestrati,Maria Martin Asiain,Kyriakos Flouris,Markus Obmann,Clarisse Dromain,Benoît Dufour,Pierre-Alexandre Alois Poletti,Hendrik von Tengg-Kobligk,Rolf Hügli,Martin Kretzschmar,Hatem Alkadhi,Ender Konukoglu,Henning Müller,Bram Stieltjes,Adrien Depeursinge*

Main category: cs.CV

TL;DR: 论文提出了一个开源基准数据集，用于促进AI在CT分析中的泛化能力，通过消除数据分布偏移问题。


<details>
  <summary>Details</summary>
Motivation: AI在医学影像分析中因数据分布偏移（如扫描仪差异）导致泛化能力差，需要解决这一问题。

Method: 使用标准化的体模CT扫描数据集（1378个图像系列），结合公开的基准方法和代码，评估图像和特征稳定性。

Result: 提供了一个包含多厂商扫描仪数据的基准数据集，并展示了基线结果以支持AI协调技术的发展。

Conclusion: 该数据集和方法为开发AI协调技术提供了重要资源，有助于解决医学影像中的分布偏移问题。
...
### [138] [Interpolation-Based Event Visual Data Filtering Algorithms](https://arxiv.org/abs/2507.01557)
*Marcin Kowlaczyk,Tomasz Kryjak*
...
### [139] [How Well Does GPT-4o Understand Vision? Evaluating Multimodal Foundation Models on Standard Computer Vision Tasks](https://arxiv.org/abs/2507.01955)
*Rahul Ramachandran,Ali Garjani,Roman Bachmann,Andrei Atanov,Oğuzhan Fatih Kar,Amir Zamir*
...
Result: 模型在语义任务上表现较好，几何任务稍弱；GPT-4o在非推理模型中表现最佳；推理模型在几何任务上有提升。
...
Result: 在五个遥感语义分割数据集上验证了IDGBR能一致改进边界精度。

Conclusion: IDGBR框架有效结合了两种学习的优势，提升了语义分割的边界精度。
...
TL;DR: Locality-aware Parallel Decoding (LPD) 通过灵活的自回归建模和局部感知生成顺序，显著加速了自回归图像生成，同时保持生成质量。


<details>
  <summary>Details</summary>
Motivation: 传统自回归图像生成依赖顺序预测，导致高延迟；现有方法尝试并行化但效果有限。

Method: 提出两种技术：1) 灵活并行自回归建模，支持任意生成顺序和并行度；2) 局部感知生成顺序，最小化组内依赖。

Result: 在 ImageNet 上，生成步骤从 256 降至 20（256x256），1024 降至 48（512x512），延迟降低至少 3.4 倍。

Conclusion: LPD 在保持质量的同时，显著提升了自回归图像生成的效率。
...
### [142] [SketchColour: Channel Concat Guided DiT-based Sketch-to-Colour Pipeline for 2D Animation](https://arxiv.org/abs/2507.01586)
*Bryan Constantine Sadihin,Michael Hua Wang,Shei Pern Chua,Hang Su*

Main category: cs.CV

TL;DR: SketchColour提出了一种基于扩散变压器（DiT）的草图到色彩转换方法，显著减少了参数和GPU内存使用，并在SAKUGA数据集上表现优于现有方法。


<details>
  <summary>Details</summary>
Motivation: 传统2D动画制作中，手动绘制和着色大量帧非常耗时，因此需要一种高效的自动化方法。

Method: 采用扩散变压器（DiT）架构，通过轻量级通道拼接适配器和LoRA微调注入草图信息，避免ControlNet的参数膨胀。

Result: 在SAKUGA数据集上表现优于现有方法，仅用一半训练数据，且生成动画时间一致、伪影少。

Conclusion: SketchColour是一种高效、低成本的2D动画着色解决方案，具有实际应用潜力。
...
### [143] [Towards Controllable Real Image Denoising with Camera Parameters](https://arxiv.org/abs/2507.01587)
*Youngjin Oh,Junhyeong Kwon,Keuntek Lee,Nam Ik Cho*
...
### [144] [DepthSync: Diffusion Guidance-Based Depth Synchronization for Scale- and Geometry-Consistent Video Depth Estimation](https://arxiv.org/abs/2507.01603)
*Yue-Jiang Dong,Wang Zhao,Jiale Xu,Ying Shan,Song-Hai Zhang*
...
<details>
  <summary>Details</summary>
Motivation: 现有方法在处理长视频时存在尺度不一致和几何不一致的问题，仅依赖2D扩散先验忽略了3D几何结构。

Method: 提出DepthSync框架，引入尺度引导和几何引导，协同优化去噪过程以实现一致性预测。

Result: 实验验证了DepthSync在多个数据集上能显著提升长视频深度预测的尺度和几何一致性。

Conclusion: DepthSync通过结合尺度和几何引导，有效解决了长视频深度预测的一致性问题。
...
### [145] [Perception-Oriented Latent Coding for High-Performance Compressed Domain Semantic Inference](https://arxiv.org/abs/2507.01608)
*Xu Zhang,Ming Lu,Yan Chen,Zhan Ma*

Main category: cs.CV

TL;DR: POLC是一种感知导向的潜在编码方法，通过丰富潜在特征的语义内容，提升压缩域语义推理性能，同时减少微调参数。
...
### [146] [SAILViT: Towards Robust and Generalizable Visual Backbones for MLLMs via Gradual Feature Refinement](https://arxiv.org/abs/2507.01643)
*Weijie Yin,Dingkang Yang,Hongyuan Dong,Zijian Kang,Jiacong Wang,Xiao Liang,Chao Feng,Jiao Ran*
...
<details>
  <summary>Details</summary>
Motivation: 现有ViTs因参数初始化冲突和模态语义差距难以与LLMs直接协同训练。

Method: 通过逐步特征细化实现粗到细的特征对齐和知识注入。

Result: SAILViT在OpenCompass基准测试中显著提升MLLMs性能。

Conclusion: SAILViT展示了强大的鲁棒性和泛化能力，适用于多种场景。
...
### [147] [RobuSTereo: Robust Zero-Shot Stereo Matching under Adverse Weather](https://arxiv.org/abs/2507.01653)
*Yuran Wang,Yingping Liang,Yutao Hu,Ying Fu*
...
<details>
  <summary>Details</summary>
Motivation: 现有学习型立体匹配模型在恶劣天气下表现不佳，主要因数据稀缺和特征提取困难。

Method: 1. 提出基于扩散的模拟管道，生成高质量恶劣天气立体数据；2. 设计结合ConvNet和去噪Transformer的鲁棒特征编码器。
...
### [148] [SPoT: Subpixel Placement of Tokens in Vision Transformers](https://arxiv.org/abs/2507.01654)
*Martine Hjelkrem-Tan,Marius Aasan,Gabriel Y. Arteaga,Adín Ramírez Rivera*
...
Method: 提出Subpixel Placement of Tokens (SPoT)，通过连续放置标记和oracle-guided搜索优化标记位置。
...
### [149] [What does really matter in image goal navigation?](https://arxiv.org/abs/2507.01667)
*Gianluca Monaci,Philippe Weinzaepfel,Christian Wolf*

Main category: cs.CV

TL;DR: 研究探讨了端到端强化学习训练是否有效解决图像目标导航任务，分析了架构选择和模拟器设置的影响，并展示了部分能力可迁移到现实场景。


<details>
  <summary>Details</summary>
Motivation: 探索端到端强化学习训练在图像目标导航任务中的有效性，以验证是否可以通过导航奖励训练相对姿态估计。

Method: 通过大规模研究分析架构选择（如延迟融合、通道堆叠、空间到深度投影和交叉注意力）及其在导航训练中相对姿态估计器的作用。

Result: 发现模拟器设置对方法成功有影响，但部分能力可迁移到更现实场景；导航性能与相对姿态估计性能相关。

Conclusion: 端到端强化学习训练在图像目标导航中部分有效，但需注意模拟器设置的影响，且能力迁移有限。
...
### [150] [Facial Emotion Learning with Text-Guided Multiview Fusion via Vision-Language Model for 3D/4D Facial Expression Recognition](https://arxiv.org/abs/2507.01673)
*Muzammil Behzad*
...
Method: 提出CVSA用于视角一致融合，MTGF用于语义对齐，以及多视角一致性损失函数。
...
### [151] [Component Adaptive Clustering for Generalized Category Discovery](https://arxiv.org/abs/2507.01711)
*Mingfu Yan,Jiancheng Huang,Yifan Liu,Shifeng Chen*
...
<details>
  <summary>Details</summary>
Motivation: 传统方法依赖预定义类别数量等刚性假设，难以处理现实数据的复杂性和变异性。

Method: 提出AdaGCD框架，结合自适应槽注意力（AdaSlot），动态确定最佳槽数量，实现灵活聚类。

Result: 在公开和细粒度数据集上的实验验证了AdaGCD的有效性，尤其在利用空间局部信息方面表现突出。

Conclusion: AdaGCD通过自适应表示和动态槽分配，显著提升了开放世界场景下的类别发现能力。
...
### [152] [Using Wavelet Domain Fingerprints to Improve Source Camera Identification](https://arxiv.org/abs/2507.01712)
*Xinle Tian,Matthew Nunes,Emiko Dupont,Shaunagh Downing,Freddie Lichtenstein,Matt Burns*

Main category: cs.CV

TL;DR: 提出了一种基于小波域的相机指纹检测方法，避免了传统图像指纹的反转步骤，提高了检测精度和处理速度。


<details>
  <summary>Details</summary>
Motivation: 传统小波去噪方法在提取传感器模式噪声（SPN）时需要将指纹构建为图像并进行反转，效率较低。
...
### [153] [Soft Self-labeling and Potts Relaxations for Weakly-Supervised Segmentation](https://arxiv.org/abs/2507.01721)
*Zhongwen Zhang,Yuri Boykov*
...
Method: 提出了一种原则性的辅助损失，并系统评估了标准及新的CRF松弛形式、邻域系统和网络预测与软伪标签的连接项。同时提出了一种通用的连续子问题求解器。

Result: 软自标记方法在标准架构下显著提升了涂鸦标签的训练效果，甚至优于完全像素级监督方法。

Conclusion: 软自标记方法不仅适用于弱监督分割，还可推广到其他弱监督问题/系统中。
...
### [154] [When Does Pruning Benefit Vision Representations?](https://arxiv.org/abs/2507.01722)
*Enrico Cassano,Riccardo Renzulli,Andrea Bragagnolo,Marco Grangetto*

Main category: cs.CV

TL;DR: 本文研究了剪枝对视觉模型在可解释性、无监督目标发现和人类感知对齐三个维度的影响，发现稀疏模型存在性能最佳点，但效果高度依赖网络架构和参数规模。


<details>
  <summary>Details</summary>
Motivation: 剪枝虽能降低深度学习模型的复杂度，但其对可解释性和表示学习的影响尚不明确，因此需要系统研究。

Method: 通过分析不同视觉网络架构在不同稀疏度下的特征归因方法，探索剪枝是否促进更简洁的结构化表示，并评估剪枝是否增强模型与人类感知的对齐。

Result: 研究发现稀疏模型在特定条件下（最佳点）表现出更高的可解释性、下游泛化能力和人类对齐性，但效果因网络架构和参数规模而异。
...
### [155] [HOI-Dyn: Learning Interaction Dynamics for Human-Object Motion Diffusion](https://arxiv.org/abs/2507.01737)
*Lin Wu,Zhixiang Chen,Jianglin Lan*

Main category: cs.CV

TL;DR: HOI-Dyn框架通过驱动-响应系统生成更真实的3D人-物交互，利用轻量级Transformer模型预测物体对人物动作的反应，并通过动态损失函数提升一致性。


<details>
  <summary>Details</summary>
Motivation: 现有方法将人物和物体运动独立处理，导致物理上不合理且因果不一致的行为，因此需要更精确的交互动态建模。

Method: 提出HOI-Dyn框架，采用驱动-响应系统，结合Transformer模型预测物体响应，并引入残差动态损失函数。

Result: 实验表明，该方法提升了交互生成质量，并提供了可行的评估指标。

Conclusion: HOI-Dyn通过动态建模和损失函数优化，显著改善了3D人-物交互的真实性和一致性。
...
### [156] [DeRIS: Decoupling Perception and Cognition for Enhanced Referring Image Segmentation through Loopback Synergy](https://arxiv.org/abs/2507.01738)
*Ming Dai,Wenxuan Cheng,Jiang-jiang Liu,Sen Yang,Wenxiao Cai,Yanpeng Sun,Wankou Yang*

Main category: cs.CV

TL;DR: DeRIS框架将Referring Image Segmentation分解为感知和认知两部分，发现当前模型的瓶颈在于多模态认知能力不足，并提出Loopback Synergy机制和数据增强方法提升性能。
...
### [157] [Calibrated Self-supervised Vision Transformers Improve Intracranial Arterial Calcification Segmentation from Clinical CT Head Scans](https://arxiv.org/abs/2507.01744)
*Benjamin Jin,Grant Mair,Joanna M. Wardlaw,Maria del C. Valdés Hernández*
...
<details>
  <summary>Details</summary>
Motivation: 3D ViTs在医学图像分割中表现不佳，但其自监督训练特性使其适用于缺乏标注的大规模医学影像数据。IAC作为神经血管疾病的生物标志物，自动化量化有助于大规模风险评估。

Method: 通过MAE框架预训练ViTs，并在IST-3临床试验的异构数据上微调用于IAC分割。研究了ViTs的关键设计选择，如低patch大小和插值上采样。

Result: 自监督ViT在Dice分数上比监督nnU-Net基线高3.2分；低patch大小和插值上采样对ViTs表现至关重要；ViTs对高切片厚度更具鲁棒性，临床风险分类提升46%。

Conclusion: MAE预训练的ViTs在IAC分割中表现出色，为医学图像分析提供了高效且鲁棒的解决方案。
...
### [158] [SSL4SAR: Self-Supervised Learning for Glacier Calving Front Extraction from SAR Imagery](https://arxiv.org/abs/2507.01747)
*Nora Gourmelon,Marcel Dreier,Martin Mayr,Thorsten Seehaus,Dakota Pyles,Matthias Braun,Andreas Maier,Vincent Christlein*
...
Result: 在CaFFe数据集上平均距离误差293米，优于之前最佳模型67米；集成模型误差75米，接近人类水平38米。

Conclusion: 新技术显著提升冰川崩解前沿监测精度，支持季节性变化的高精度追踪。
...
### [159] [Rethinking Discrete Tokens: Treating Them as Conditions for Continuous Autoregressive Image Synthesis](https://arxiv.org/abs/2507.01756)
*Peng Zheng,Junke Wang,Yi Chang,Yizhou Yu,Rui Ma,Zuxuan Wu*
...
### [160] [Boosting Adversarial Transferability Against Defenses via Multi-Scale Transformation](https://arxiv.org/abs/2507.01791)
*Zihong Guo,Chen Wan,Yayin Zheng,Hailing Kuang,Xiaohai Lu*

Main category: cs.CV

TL;DR: 提出了一种新的分段高斯金字塔（SGP）攻击方法，通过多尺度图像处理和梯度平均增强对抗样本的可迁移性，显著提高了对黑盒防御模型的攻击成功率。
...
Conclusion: SGP是一种高扩展性的输入变换方法，可轻松集成到现有对抗攻击中，有效增强对抗样本的可迁移性。
...
### [161] [FreeLoRA: Enabling Training-Free LoRA Fusion for Autoregressive Multi-Subject Personalization](https://arxiv.org/abs/2507.01792)
*Peng Zheng,Ye Wang,Rui Ma,Zuxuan Wu*
...
<details>
  <summary>Details</summary>
Motivation: 现有方法在多主题个性化中表现不佳，需要复杂的调整或联合优化。FreeLoRA旨在简化这一过程。

Method: 采用Full Token Tuning策略训练每个LoRA模块，并在推理时使用Subject-Aware Inference激活对应模块。
...
### [162] [HCNQA: Enhancing 3D VQA with Hierarchical Concentration Narrowing Supervision](https://arxiv.org/abs/2507.01800)
*Shengli Zhou,Jianuo Zhu,Qilin Huang,Fangjing Wang,Yanfu Zhang,Feng Zheng*
...
<details>
  <summary>Details</summary>
Motivation: 现有3D VQA模型的答案中心监督方法缺乏对推理路径的监督，可能导致模型依赖浅层捷径，且慢思考方法存在欠思考问题。

Method: 采用分层浓度缩小监督方法，通过三个阶段的分层监督，引导模型从广泛区域逐步聚焦到特定对象。

Result: 实验证明，该方法能有效确保模型发展出合理的推理路径，并取得更好的性能。

Conclusion: HCNQA通过分层监督解决了3D VQA模型推理路径监督不足的问题，提升了模型性能。
...
### [163] [AMD: Adaptive Momentum and Decoupled Contrastive Learning Framework for Robust Long-Tail Trajectory Prediction](https://arxiv.org/abs/2507.01801)
*Bin Rao,Haicheng Liao,Yanchen Guan,Chengyue Wang,Bonan Wang,Jiaxun Zhang,Zhenning Li*
...
<details>
  <summary>Details</summary>
Motivation: 现有研究仅依赖基础模型的预测误差，忽略了长尾轨迹模式的多样性和不确定性，导致对复杂和危险场景的预测能力不足。

Method: 结合改进的动量对比学习（MoCo-DT）和解耦对比学习（DCL），设计四种轨迹随机增强方法和在线迭代聚类策略，动态更新伪标签以适应长尾数据分布。
...
### [164] [Modulate and Reconstruct: Learning Hyperspectral Imaging from Misaligned Smartphone Views](https://arxiv.org/abs/2507.01835)
*Daniil Reutsky,Daniil Vladimirov,Yasin Mamedov,Georgy Perevozchikov,Nancy Mehta,Egor Ershov,Radu Timofte*
...
Method: 采用三摄像头系统，其中两个镜头配备特定光谱滤镜，结合理论与实证分析，提出MI-HSR框架，并创建首个相关数据集Doomer。
...
### [165] [MobileIE: An Extremely Lightweight and Effective ConvNet for Real-Time Image Enhancement on Mobile Devices](https://arxiv.org/abs/2507.01838)
*Hailong Yan,Ao Li,Xiangtao Zhang,Zhe Liu,Zenglin Shi,Ce Zhu,Le Zhang*

Main category: cs.CV

TL;DR: 提出了一种极轻量级的CNN框架，用于移动设备上的实时图像增强，参数仅约4K，实现了1,100 FPS的推理速度。
...
Result: 首次实现1,100 FPS的实时图像增强推理，同时保持竞争力的图像质量。

Conclusion: 该框架在速度和性能之间实现了最佳平衡，适用于多种图像增强任务。
...
### [166] [Future Slot Prediction for Unsupervised Object Discovery in Surgical Video](https://arxiv.org/abs/2507.01882)
*Guiqiu Liao,Matjaz Jogan,Marcel Hussing,Edward Zhang,Eric Eaton,Daniel A. Hashimoto*
...
### [167] [Self-Reinforcing Prototype Evolution with Dual-Knowledge Cooperation for Semi-Supervised Lifelong Person Re-Identification](https://arxiv.org/abs/2507.01884)
*Kunlun Xu,Fan Zhuo,Jiangmeng Li,Xu Zou,Jiahuan Zhou*

Main category: cs.CV

TL;DR: 本文提出了一种新型的自我强化原型进化与双知识合作框架（SPRED），用于解决半监督终身行人重识别（Semi-LReID）问题，显著提升了未标记数据的利用效率和长期适应性能。


<details>
  <summary>Details</summary>
Motivation: 现实场景中标注资源有限，现有LReID方法在未标记数据利用时性能下降严重，且难以处理噪声知识。

Method: 引入可学习的身份原型动态捕捉身份分布并生成高质量伪标签，通过双知识合作方案整合当前模型和历史模型知识以净化噪声。

Result: 在Semi-LReID基准测试中，SPRED实现了最先进的性能。

Conclusion: SPRED通过自我强化循环设计，显著提升了未标记数据的利用效率和长期学习性能。
...
### [168] [Reasoning to Edit: Hypothetical Instruction-Based Image Editing with Visual Reasoning](https://arxiv.org/abs/2507.01908)
*Qingdong He,Xueqin Chen,Chaoyi Wang,Yanjie Pan,Xiaobin Hu,Zhenye Gan,Yabiao Wang,Chengjie Wang,Xiangtai Li,Jiangning Zhang*
...
<details>
  <summary>Details</summary>
Motivation: 现有方法难以处理需要深层推理的复杂隐式假设指令，且缺乏支持推理的训练数据集和架构机制。

Method: 提出Reason50K数据集和ReasonBrain框架，结合多模态大语言模型和扩散模型，并引入细粒度推理线索提取模块和跨模态增强器。

Result: ReasonBrain在推理场景中表现优于现有方法，并在零样本任务中展现出强泛化能力。

Conclusion: Reason50K和ReasonBrain为复杂指令图像编辑提供了有效解决方案，具有广泛的应用潜力。
...
### [169] [Modality Agnostic, patient-specific digital twins modeling temporally varying digestive motion](https://arxiv.org/abs/2507.01909)
*Jorge Tapias Gomez,Nishant Nadkarni,Lando S. Bosma,Jue Jiang,Ergys D. Subashi,William P. Segars,James M. Balter,Mert R Sabuncu,Neelam Tyagi,Harini Veeraraghavan*

Main category: cs.CV

TL;DR: 该研究提出了一种基于患者特异性数字孪生（DT）的管道，用于评估变形图像配准（DIR）方法的准确性，特别是在高度移动的胃肠道器官中。通过模拟真实胃肠道运动，该管道能够提供详细的定量DIR性能指标和剂量映射验证。


<details>
  <summary>Details</summary>
Motivation: 临床实施DIR需要基于体素的空间准确性指标，如手动标记的解剖标志，但这些方法在高度移动的胃肠道器官中难以实现。因此，研究团队开发了DT模型来模拟真实胃肠道运动，以评估DIR方法的准确性。

Method: 研究团队通过半自动化管道，从静态3D患者扫描中生成21个模拟胃肠道运动的4D序列，并创建了11个数据集（包括MRI和CT扫描）。使用这些DT模型评估了六种DIR方法的性能，包括目标配准误差、Dice相似系数和Hausdorff距离等指标。此外，还对剂量分布进行了变形和累积分析。

Result: 生成的DT模型能够模拟真实的胃肠道运动，其运动幅度与真实患者数据相似（平均和最大运动幅度分别小于0.8 mm和0.01）。该管道能够提供详细的DIR性能指标，并验证了剂量映射的准确性。

Conclusion: 该研究提出的管道能够严格测试DIR工具在动态且解剖复杂区域的性能，为临床提供了空间和剂量学准确性的详细验证方法。
...
### [170] [3D Reconstruction and Information Fusion between Dormant and Canopy Seasons in Commercial Orchards Using Deep Learning and Fast GICP](https://arxiv.org/abs/2507.01912)
*Ranjan Sapkota,Zhichao Meng,Martin Churuvija,Xiaoqiang Du,Zenghong Ma,Manoj Karkee*

Main category: cs.CV

TL;DR: 提出一种信息融合框架，结合休眠期和生长期的果树结构数据，支持全生长季的机器人自动化管理。


<details>
  <summary>Details</summary>
Motivation: 果树在生长期因茂密树叶遮挡结构，影响机器视觉系统；休眠期树叶脱落，结构更清晰。

Method: 使用YOLOv9-Seg进行实例分割，Kinect Fusion进行3D重建，Fast GICP进行模型对齐。

Result: YOLOv9-Seg的MSE为0.0047，分割mAP@50达0.78；Kinect Fusion的RMSE为5.23 mm（树干直径）；Fast GICP的配准分数为0.00197。

Conclusion: 融合框架解决了生长期遮挡问题，提升了修剪等自动化操作的精度。
...
### [171] [IC-Custom: Diverse Image Customization via In-Context Learning](https://arxiv.org/abs/2507.01926)
*Yaowei Li,Xiaoyu Li,Zhaoyang Zhang,Yuxuan Bian,Gan Liu,Xinyuan Li,Jiale Xu,Wenbo Hu,Yating Liu,Lingen Li,Jing Cai,Yuexian Zou,Yancheng He,Ying Shan*
...
<details>
  <summary>Details</summary>
Motivation: 解决现有图像定制方法缺乏通用框架的问题，支持多样化的工业应用场景。

Method: 提出IC-Custom框架，结合多模态注意力机制和任务导向的注册令牌，使用高质量数据集进行训练。

Result: 在身份一致性、和谐性和文本对齐方面，IC-Custom比现有方法表现更好，人类偏好提高73%。
...
### [172] [evMLP: An Efficient Event-Driven MLP Architecture for Vision](https://arxiv.org/abs/2507.01927)
*Zhentan Zheng*

Main category: cs.CV

TL;DR: 该论文提出了一种名为evMLP的模型，通过事件驱动的局部更新机制，选择性处理图像或特征图中的变化区域，显著提升了计算效率，同时在图像分类和视频处理任务中保持了与现有先进模型相当的准确性。


<details>
  <summary>Details</summary>
Motivation: 探索多层感知机（MLPs）在视觉任务中的应用，并解决传统方法在处理序列图像数据（如视频）时存在的冗余计算问题。

Method: 提出evMLP模型，结合事件驱动的局部更新机制，仅处理图像或特征图中发生变化的区域（定义为“事件”）。

Result: 在ImageNet图像分类任务中达到与先进模型相当的准确性；在视频数据集上显著降低计算成本，同时保持输出一致性。
...
### [173] [CI-VID: A Coherent Interleaved Text-Video Dataset](https://arxiv.org/abs/2507.01938)
*Yiming Ju,Jijin Hu,Zhengxiong Luo,Haoge Deng,hanyu Zhao,Li Du,Chengwei Wu,Donglin Hao,Xinlong Wang,Tengfei Pan*
...
Method: 提出CI-VID数据集，包含34万样本，每个样本由连贯的视频片段序列及其文本描述组成，支持文本和视频到视频的生成。
...
### [174] [LongAnimation: Long Animation Generation with Dynamic Global-Local Memory](https://arxiv.org/abs/2507.01945)
*Nan Chen,Mengqi Huang,Yihao Meng,Zhendong Mao*
...
<details>
  <summary>Details</summary>
Motivation: 长动画着色在动画产业中成本高昂，现有研究局限于短期着色，缺乏全局信息导致颜色一致性不足。
...
Conclusion: LongAnimation通过动态全局-局部范式解决了长期颜色一致性问题，为开放域动画着色任务提供了有效方案。
...
### [175] [Kwai Keye-VL Technical Report](https://arxiv.org/abs/2507.01949)
*Kwai Keye Team,Biao Yang,Bin Wen,Changyi Liu,Chenglong Chu,Chengru Song,Chongling Rao,Chuan Yi,Da Li,Dunju Zang,Fan Yang,Guorui Zhou,Hao Peng,Haojie Ding,Jiaming Huang,Jiangxia Cao,Jiankang Chen,Jingyun Hua,Jin Ouyang,Kaibing Chen,Kaiyu Jiang,Kaiyu Tang,Kun Gai,Shengnan Zhang,Siyang Mao,Sui Huang,Tianke Zhang,Tingting Gao,Wei Chen,Wei Yuan,Xiangyu Wu,Xiao Hu,Xingyu Lu,Yang Zhou,Yi-Fan Zhang,Yiping Yang,Yulong Chen,Zhenhua Wu,Zhenyu Li,Zhixin Ling,Ziming Li,Dehua Ma,Di Xu,Haixuan Gao,Hang Li,Jiawei Guo,Jing Wang,Lejian Ren,Muhao Wei,Qianqian Wang,Qigen Hu,Shiyao Wang,Tao Yu,Xinchen Luo,Yan Li,Yiming Liang,Yuhang Hu,Zeyi Lu,Zhuoran Yang,Zixing Zhang*
...
Result: 在公共视频基准测试中取得领先成绩，并在通用图像任务中保持竞争力。

Conclusion: Kwai Keye-VL在短视频理解方面表现出色，并通过新基准KC-MMBench验证了其优势。
...
### [176] [FreeMorph: Tuning-Free Generalized Image Morphing with Diffusion Model](https://arxiv.org/abs/2507.01953)
*Yukang Cao,Chenyang Si,Jinghao Wang,Ziwei Liu*

Main category: cs.CV

TL;DR: FreeMorph是一种无需调优的图像变形方法，适用于不同语义或布局的输入，通过创新的插值和注意力模块设计，实现了高质量且快速的图像变形。
...
Method: 1) 提出基于输入图像显式指导的球面插值设计，修改自注意力模块以解决身份丢失问题；2) 引入步骤导向的变化趋势，混合输入图像的自注意力模块以实现可控过渡。

Result: FreeMorph在图像变形任务中表现优于现有方法，速度提升10~50倍，达到新的最优水平。

Conclusion: FreeMorph通过创新的设计解决了无需调优方法的质量问题，为图像变形领域提供了高效且高质量的解决方案。
...
### [177] [A LoD of Gaussians: Unified Training and Rendering for Ultra-Large Scale Reconstruction with External Memory](https://arxiv.org/abs/2507.01110)
...
### [178] [Semiautomatic Simplification](https://arxiv.org/abs/2507.01116)
...
### [179] [Multi-Focus Probes for Context-Preserving Network Exploration and Interaction in Immersive Analytics](https://arxiv.org/abs/2507.01140)
...
### [180] [A LoD of Gaussians: Unified Training and Rendering for Ultra-Large Scale Reconstruction with External Memory](https://arxiv.org/abs/2507.01110)
*Felix Windisch,Lukas Radl,Thomas Köhler,Michael Steiner,Dieter Schmalstieg,Markus Steinberger*
...
<details>
  <summary>Details</summary>
Motivation: 解决现有高斯溅射技术在扩展到大场景时因分区导致的边界伪影、训练复杂性和GPU内存限制问题。

Method: 采用混合数据结构（高斯层次结构与顺序点树）和轻量级缓存视图调度系统，动态流式传输相关高斯数据。

Result: 实现了无缝多尺度重建和复杂场景的交互式可视化，从广角航拍到地面细节。
...
### [181] [Semiautomatic Simplification](https://arxiv.org/abs/2507.01116)
*Gong Li,Benjamin Watson*

Main category: cs.GR

TL;DR: 介绍了一种半自动三维多边形模型简化工具semisimp，允许用户干预简化过程以保留重要语义区域。


<details>
  <summary>Details</summary>
Motivation: 现有自动简化技术无法区分语义重要区域（如面部和肢体）或适应模型使用约束（如动画）。

Method: 用户可调整简化顺序、重新定位顶点并调整模型表面的分层分区。

Result: 工具能更好地保留重要区域，并优化简化模型的质量。

Conclusion: semisimp提供了更灵活的控制，适用于需要保留语义细节的场景。
...
### [182] [Multi-Focus Probes for Context-Preserving Network Exploration and Interaction in Immersive Analytics](https://arxiv.org/abs/2507.01140)
*Eric Zimmermann,Stefan Bruckner*
...
<details>
  <summary>Details</summary>
Motivation: 解决用户在沉浸式环境中管理复杂网络数据时，局部与全局视图切换的挑战。

Method: 采用多焦点探针技术，支持用户创建多个局部子图视图，同时保持与全局网络的链接，并通过视觉和触觉引导机制确保上下文一致性。

Result: 展示了该技术在网络数据编辑中的可用性。

Conclusion: 该技术有效支持多尺度交互，提升了网络数据编辑的体验。
...
### [183] [MALIBU Benchmark: Multi-Agent LLM Implicit Bias Uncovered](https://arxiv.org/abs/2507.01019)
...
### [184] [Event-based evaluation of abstractive news summarization](https://arxiv.org/abs/2507.01160)
...
### [185] [Matching and Linking Entries in Historical Swedish Encyclopedias](https://arxiv.org/abs/2507.01170)
...
### [186] [MEGA: xLSTM with Multihead Exponential Gated Fusion for Precise Aspect-based Sentiment Analysis](https://arxiv.org/abs/2507.01213)
...
### [187] [The Medium Is Not the Message: Deconfounding Text Embeddings via Linear Concept Erasure](https://arxiv.org/abs/2507.01234)
...
### [188] [GAIus: Combining Genai with Legal Clauses Retrieval for Knowledge-based Assistant](https://arxiv.org/abs/2507.01259)
...
### [189] [Evaluating Large Language Models for Multimodal Simulated Ophthalmic Decision-Making in Diabetic Retinopathy and Glaucoma Screening](https://arxiv.org/abs/2507.01278)
...
### [190] [Rethinking All Evidence: Enhancing Trustworthy Retrieval-Augmented Generation via Conflict-Driven Summarization](https://arxiv.org/abs/2507.01281)
...
### [191] [Frustratingly Simple Retrieval Improves Challenging, Reasoning-Intensive Benchmarks](https://arxiv.org/abs/2507.01297)
...
### [192] [La RoSA: Enhancing LLM Efficiency via Layerwise Rotated Sparse Activation](https://arxiv.org/abs/2507.01299)
...
### [193] [Symbolic or Numerical? Understanding Physics Problem Solving in Reasoning LLMs](https://arxiv.org/abs/2507.01334)
...
### [194] [LEDOM: An Open and Fundamental Reverse Language Model](https://arxiv.org/abs/2507.01335)
...
### [195] [Skywork-Reward-V2: Scaling Preference Data Curation via Human-AI Synergy](https://arxiv.org/abs/2507.01352)
...
### [196] [Clinical NLP with Attention-Based Deep Learning for Multi-Disease Prediction](https://arxiv.org/abs/2507.01437)
...
### [197] [LogitSpec: Accelerating Retrieval-based Speculative Decoding via Next Next Token Speculation](https://arxiv.org/abs/2507.01449)
...
### [198] [Evaluating the Effectiveness of Direct Preference Optimization for Personalizing German Automatic Text Simplifications for Persons with Intellectual Disabilities](https://arxiv.org/abs/2507.01479)
...
### [199] [Efficient Out-of-Scope Detection in Dialogue Systems via Uncertainty-Driven LLM Routing](https://arxiv.org/abs/2507.01541)
...
### [200] [Is External Information Useful for Stance Detection with LLMs?](https://arxiv.org/abs/2507.01543)
...
### [201] [Emotionally Intelligent Task-oriented Dialogue Systems: Architecture, Representation, and Optimisation](https://arxiv.org/abs/2507.01594)
...
### [202] [Chart Question Answering from Real-World Analytical Narratives](https://arxiv.org/abs/2507.01627)
...
### [203] [Confidence and Stability of Global and Pairwise Scores in NLP Evaluation](https://arxiv.org/abs/2507.01633)
...
### [204] [Adapting Language Models to Indonesian Local Languages: An Empirical Study of Language Transferability on Zero-Shot Settings](https://arxiv.org/abs/2507.01645)
*Rifki Afina Putri*
...
### [205] [AdamMeme: Adaptively Probe the Reasoning Capacity of Multimodal Large Language Models on Harmfulness](https://arxiv.org/abs/2507.01702)
...
### [206] [Stereotype Detection as a Catalyst for Enhanced Bias Detection: A Multi-Task Learning Approach](https://arxiv.org/abs/2507.01715)
...
### [207] [LLMs for Legal Subsumption in German Employment Contracts](https://arxiv.org/abs/2507.01734)
...
### [208] [Data interference: emojis, homoglyphs, and issues of data fidelity in corpora and their results](https://arxiv.org/abs/2507.01764)
...
### [209] [MuRating: A High Quality Data Selecting Approach to Multilingual Large Language Model Pretraining](https://arxiv.org/abs/2507.01785)
...
### [210] [Probing Evaluation Awareness of Language Models](https://arxiv.org/abs/2507.01786)
...
### [211] [How Do Vision-Language Models Process Conflicting Information Across Modalities?](https://arxiv.org/abs/2507.01790)
...
### [212] [The Anatomy of Evidence: An Investigation Into Explainable ICD Coding](https://arxiv.org/abs/2507.01802)
...
### [213] [Evaluating Structured Output Robustness of Small Language Models for Open Attribute-Value Extraction from Clinical Notes](https://arxiv.org/abs/2507.01810)
...
### [214] [Low-Perplexity LLM-Generated Sequences and Where To Find Them](https://arxiv.org/abs/2507.01844)
...
### [215] [Eka-Eval : A Comprehensive Evaluation Framework for Large Language Models in Indian Languages](https://arxiv.org/abs/2507.01853)
...
### [216] [DIY-MKG: An LLM-Based Polyglot Language Learning System](https://arxiv.org/abs/2507.01872)
...
### [217] [MiCoTA: Bridging the Learnability Gap with Intermediate CoT and Teacher Assistants](https://arxiv.org/abs/2507.01887)
...
### [218] [High-Layer Attention Pruning with Rescaling](https://arxiv.org/abs/2507.01900)
...
### [219] [AI4Research: A Survey of Artificial Intelligence for Scientific Research](https://arxiv.org/abs/2507.01903)
...
### [220] [Gradient-Adaptive Policy Optimization: Towards Multi-Objective Alignment of Large Language Models](https://arxiv.org/abs/2507.01915)
...
### [221] [Adaptability of ASR Models on Low-Resource Language: A Comparative Study of Whisper and Wav2Vec-BERT on Bangla](https://arxiv.org/abs/2507.01931)
...
### [222] [NaturalThoughts: Selecting and Distilling Reasoning Traces for General Reasoning Tasks](https://arxiv.org/abs/2507.01921)
...
### [223] [Decision-oriented Text Evaluation](https://arxiv.org/abs/2507.01923)
...
### [224] [The Thin Line Between Comprehension and Persuasion in LLMs](https://arxiv.org/abs/2507.01936)
...
### [225] [MALIBU Benchmark: Multi-Agent LLM Implicit Bias Uncovered](https://arxiv.org/abs/2507.01019)
*Imran Mirza,Cole Huang,Ishwara Vasista,Rohan Patil,Asli Akalin,Sean O'Brien,Kevin Zhu*
...
Method: 通过场景化评估，AI模型在预定义上下文中完成任务，并由LLM多智能体评判系统分两阶段评估其响应。
...
### [226] [Event-based evaluation of abstractive news summarization](https://arxiv.org/abs/2507.01160)
*Huiling You,Samia Touileb,Erik Velldal,Lilja Øvrelid*
...
<details>
  <summary>Details</summary>
Motivation: 现有评估方法主要依赖重叠单元或相似度评分，无法充分反映摘要是否准确传达了原文的事件信息。

Method: 提出计算生成摘要、参考摘要和原文之间的事件重叠，并在挪威语数据集上进行实验。

Result: 该方法能更深入地分析摘要中包含的事件信息。

Conclusion: 基于事件重叠的评估方法为生成式摘要的质量提供了更全面的视角。
...
### [227] [Matching and Linking Entries in Historical Swedish Encyclopedias](https://arxiv.org/abs/2507.01170)
*Simon Börjesson,Erik Ersmark,Pierre Nugues*
...
<details>
  <summary>Details</summary>
Motivation: 研究目的是通过比较两个版本的百科全书，揭示瑞典在19世纪末至20世纪初的知识变化，尤其是地理条目的演变。

Method: 使用数字化文本，通过语义句子嵌入匹配条目，并利用基于Transformer的分类器提取地理条目，链接到Wikidata进行分析。

Result: 发现地理焦点从欧洲转向其他地区，尤其是北美和北欧，反映了历史事件的影响。

Conclusion: 研究证实了百科全书内容的变化与历史背景相关，为知识传播和演变提供了实证支持。
...
### [228] [MEGA: xLSTM with Multihead Exponential Gated Fusion for Precise Aspect-based Sentiment Analysis](https://arxiv.org/abs/2507.01213)
*Adamu Lawan,Juhua Pu,Haruna Yunusa,Jawad Muhammad,Muhammad Lawan*
...
<details>
  <summary>Details</summary>
Motivation: 现有ABSA方法在计算效率与性能之间难以平衡，xLSTM的潜力尚未充分挖掘。

Method: 结合双向mLSTM和部分翻转反向流（PF-mLSTM），并引入多头交叉指数门控融合机制（MECGAF）。
...
### [229] [The Medium Is Not the Message: Deconfounding Text Embeddings via Linear Concept Erasure](https://arxiv.org/abs/2507.01234)
*Yu Fan,Yang Tian,Shauli Ravfogel,Mrinmaya Sachan,Elliott Ash,Alexander Hoyle*
...
Conclusion: 去偏算法有效减少了文本嵌入中的偏差，且不损害其他性能。
...
### [230] [GAIus: Combining Genai with Legal Clauses Retrieval for Knowledge-based Assistant](https://arxiv.org/abs/2507.01259)
*Michał Matak,Jarosław A. Chudziak*

Main category: cs.CL

TL;DR: 论文探讨了大型语言模型在处理非英语和非中文国家的法律问题时提供答案和引用的能力，提出了一种基于波兰民法典的认知代理架构gAIus，其检索机制优于嵌入方法。


<details>
  <summary>Details</summary>
Motivation: 研究动机是解决LLM在法律信息检索中的局限性，特别是在非英语和非中文法律体系中的表现。

Method: 提出gAIus架构，结合检索机制，基于波兰民法典，并通过单选择题数据集评估。

Result: gAIus显著提升模型性能，gpt-3.5-turbo-0125提升419%，gpt-4o-mini从31%提升至86%。

Conclusion: 研究展示了未来研究方向及潜在应用，证明了gAIus在法律任务中的有效性。
...
### [231] [Evaluating Large Language Models for Multimodal Simulated Ophthalmic Decision-Making in Diabetic Retinopathy and Glaucoma Screening](https://arxiv.org/abs/2507.01278)
*Cindy Lie Tabuse,David Restepo,Carolina Gracitelli,Fernando Korn Malerbi,Caio Regatieri,Luis Filipe Nakayama*

Main category: cs.CL

TL;DR: GPT-4在眼科中模拟临床决策的能力被评估，结果显示其在糖尿病视网膜病变（DR）筛查中表现中等，但在青光眼筛查中表现较差，且添加临床元数据未显著改善结果。


<details>
  <summary>Details</summary>
Motivation: 探索大型语言模型（LLMs）在眼科中的应用潜力，特别是在糖尿病视网膜病变和青光眼筛查中的临床决策模拟能力。

Method: 使用300张标注的视网膜眼底照片，通过结构化提示描述图像（含或不含患者元数据），评估GPT-4在ICDR分级、DR转诊推荐和青光眼杯盘比估计中的表现。

Result: GPT-4在DR筛查中表现中等（准确率82.3%），但在青光眼筛查中表现较差（准确率约78%）。添加元数据未显著影响结果。

Conclusion: GPT-4可从结构化提示中模拟基本眼科决策，但对复杂任务缺乏精确性，不适合临床使用，可能适用于教育或文档工作。
...
### [232] [Rethinking All Evidence: Enhancing Trustworthy Retrieval-Augmented Generation via Conflict-Driven Summarization](https://arxiv.org/abs/2507.01281)
*Juan Chen,Baolong Bi,Wei Zhang,Jingyan Sui,Xiaofei Zhu,Yuanzhuo Wang,Lingrui Mei,Shenghua Liu*

Main category: cs.CL

TL;DR: CARE-RAG提出了一种冲突感知的检索增强生成框架，通过重新审视内部和外部证据提升生成可靠性。


<details>
  <summary>Details</summary>
Motivation: 解决检索增强生成（RAG）系统中因知识冲突导致的生成不可靠问题。

Method: 提出CARE-RAG框架，包括参数感知证据提取、上下文感知证据优化、冲突驱动总结及QA修复步骤。

Result: 在噪声或冲突证据场景下，CARE-RAG显著优于现有RAG基线。

Conclusion: CARE-RAG通过冲突感知和证据优化，显著提升了生成的可信度。
...
### [233] [Frustratingly Simple Retrieval Improves Challenging, Reasoning-Intensive Benchmarks](https://arxiv.org/abs/2507.01297)
*Xinxi Lyu,Michael Duan,Rulin Shao,Pang Wei Koh,Sewon Min*
...
<details>
  <summary>Details</summary>
Motivation: 现有RAG在推理密集型任务中表现有限，主要原因是缺乏与预训练数据广度对齐的高质量数据存储。

Method: 引入CompactDS，通过过滤低质量内容并结合内存近似最近邻（ANN）和磁盘精确搜索，实现高效检索。

Result: 在多个基准测试（MMLU、MMLU Pro、GPQA、MATH）中，RAG性能提升10%-33%。

Conclusion: CompactDS证明了高质量数据存储对RAG的重要性，其性能优于复杂代理系统，且具有简单性和可复现性。
...
### [234] [La RoSA: Enhancing LLM Efficiency via Layerwise Rotated Sparse Activation](https://arxiv.org/abs/2507.01299)
*Kai Liu,Bowen Xu,Shaoyu Wu,Xin Chen,Hao Zhou,Yongliang Tao,Lulu Hu*
...
Result: 在LLaMA2-7B上，40%稀疏性下仅0.17困惑度差距，1.30倍加速，零样本任务准确率差距仅0.54%。

Conclusion: LaRoSA在多种LLM上表现优异，推理加速稳定且性能损失极小。
...
### [235] [Symbolic or Numerical? Understanding Physics Problem Solving in Reasoning LLMs](https://arxiv.org/abs/2507.01334)
*Nifu Dan,Yujun Cai,Yiwei Wang*

Main category: cs.CL

TL;DR: 研究了指令调优推理模型（如Deepseek-R1）在解决复杂物理问题上的表现，发现其不仅达到最高准确率，还能生成独特的符号推导推理模式，且少量提示能进一步提升性能。


<details>
  <summary>Details</summary>
Motivation: 探索大型语言模型在物理推理中的能力，尤其是如何通过指令调优模型解决复杂物理问题。

Method: 使用Deepseek-R1等指令调优推理模型，在SciBench基准测试中评估其表现，并结合少量提示策略。

Result: 模型在复杂物理问题上达到最高准确率，并展现出独特的符号推导推理模式，少量提示还能进一步提升性能。

Conclusion: 指令调优推理模型在物理推理中表现出色，少量提示仍有优化空间，为未来性能提升提供了方向。
...
### [236] [LEDOM: An Open and Fundamental Reverse Language Model](https://arxiv.org/abs/2507.01335)
*Xunjian Yin,Sitao Cheng,Yuxi Xie,Xinyu Hu,Li Lin,Xinyi Wang,Liangming Pan,William Yang Wang,Xiaojun Wan*
...
<details>
  <summary>Details</summary>
Motivation: 探索逆向语言模型作为通用基础模型的潜力，并展示其独特能力。

Method: 训练2B和7B参数版本的LEDOM，采用逆向时序处理序列，并引入逆向奖励应用。

Result: LEDOM在数学推理任务中通过逆向奖励显著提升性能，展现出广泛的应用潜力。

Conclusion: LEDOM具有独特特性，未来研究可通过其开源资源进一步探索。
...
### [237] [Skywork-Reward-V2: Scaling Preference Data Curation via Human-AI Synergy](https://arxiv.org/abs/2507.01352)
*Chris Yuhao Liu,Liang Zeng,Yuzhen Xiao,Jujie He,Jiacai Liu,Chaojie Wang,Rui Yan,Wei Shen,Fuxiang Zhang,Jiacheng Xu,Yang Liu,Yahui Zhou*
...
<details>
  <summary>Details</summary>
Motivation: 当前奖励模型在捕捉人类偏好方面表现不佳，主要原因是偏好数据集的质量和范围有限。

Method: 设计了一个人机协同的两阶段数据标注流程，结合人类标注质量和AI的可扩展性，训练了不同规模的奖励模型。
...
### [238] [Clinical NLP with Attention-Based Deep Learning for Multi-Disease Prediction](https://arxiv.org/abs/2507.01437)
*Ting Xu,Xiaoxiao Deng,Xiandong Meng,Haifeng Yang,Yan Wu*
...
Method: 使用Transformer架构和多层自注意力机制捕捉关键医学实体及其上下文关系，结合Sigmoid多标签分类器预测疾病标签。

Result: 模型在多种性能指标上优于现有方法，具有强泛化能力。

Conclusion: 该框架为处理真实临床文本提供了高效算法基础，对多标签医学文本建模具有实际意义。
...
### [239] [LogitSpec: Accelerating Retrieval-based Speculative Decoding via Next Next Token Speculation](https://arxiv.org/abs/2507.01449)
*Tianyu Liu,Qitan Lv,Hao Li,Xing Gao,Xiao Sun*

Main category: cs.CL

TL;DR: LogitSpec是一种无需训练、即插即用的方法，通过利用最后一个token的logit预测后续token，并扩展检索范围，显著提升检索式推测解码的效率。


<details>
  <summary>Details</summary>
Motivation: 现有检索式推测解码方法难以找到匹配且准确的草案token，限制了其效率和部署难度。

Method: LogitSpec分两步生成草案token：1) 利用最后一个token的logit预测下一个token；2) 检索与预测token相关的参考内容。

Result: 实验表明，LogitSpec在多种文本生成任务中可实现最高2.61倍的加速和每步3.28个平均接受token。

Conclusion: LogitSpec通过优化检索范围，显著提升了推测解码的效率，且易于集成到现有框架中。
...
### [240] [Evaluating the Effectiveness of Direct Preference Optimization for Personalizing German Automatic Text Simplifications for Persons with Intellectual Disabilities](https://arxiv.org/abs/2507.01479)
*Yingqiang Gao,Kaede Johnson,David Froehlich,Luisa Carrer,Sarah Ebling*

Main category: cs.CL

TL;DR: 论文提出了一种基于直接偏好优化（DPO）的个性化文本简化方法，通过结合目标群体（如智力障碍者）的反馈，优化大型语言模型（LLMs）的生成结果。


<details>
  <summary>Details</summary>
Motivation: 现有基于LLM的自动文本简化（ATS）系统缺乏目标群体的偏好反馈，导致个性化不足。

Method: 扩展了监督微调（SFT）方法，采用DPO技术，结合目标群体的人类反馈进行模型后训练。

Result: 提出了一个开发个性化ATS系统的完整流程，并验证了目标群体参与设计的重要性。

Conclusion: 个性化AI辅助系统需要目标群体的直接参与，以确保符合其需求。
...
### [241] [Efficient Out-of-Scope Detection in Dialogue Systems via Uncertainty-Driven LLM Routing](https://arxiv.org/abs/2507.01541)
*Álvaro Zaera,Diana Nicoleta Popa,Ivan Sekulic,Paolo Rosso*
...
Method: 1. 对现有分类器输出进行不确定性估计；2. 触发微调LLM对高不确定性实例做最终决策。

Result: 在关键OOS检测基准测试中取得最优结果，包括实际部署系统的数据。
...
### [242] [Is External Information Useful for Stance Detection with LLMs?](https://arxiv.org/abs/2507.01543)
*Quang Minh Nguyen,Taegyoon Kim*

Main category: cs.CL

TL;DR: 研究评估了外部信息（如维基百科和网络搜索）对大型语言模型（LLM）在立场检测任务中的影响，发现其多数情况下会降低性能，并揭示了LLM倾向于与提供的信息立场对齐而非真实立场。


<details>
  <summary>Details</summary>
Motivation: 探讨外部信息是否对LLM在立场检测任务中有益，填补现有研究的空白。

Method: 系统评估了八种LLM在三个数据集上的表现，分析外部信息对其立场检测性能的影响。

Result: 外部信息多数情况下降低了性能，F1分数下降高达27.9%，且LLM倾向于与提供的信息立场对齐。

Conclusion: 研究揭示了LLM在立场检测中的信息偏差风险，与BERT等模型的研究结果形成对比。
...
### [243] [Emotionally Intelligent Task-oriented Dialogue Systems: Architecture, Representation, and Optimisation](https://arxiv.org/abs/2507.01594)
*Shutong Feng,Hsien-chin Lin,Nurul Lubis,Carel van Niekerk,Michael Heck,Benjamin Ruppik,Renato Vukovic,Milica Gašić*
...
<details>
  <summary>Details</summary>
Motivation: 尽管LLM在语言流畅性和上下文理解方面取得进展，但构建兼具任务高效性和情感智能的任务导向对话系统仍具挑战性。

Method: 提出LUSTER系统，结合LLM能力和结构化奖励模型，通过短期（用户情感）和长期（任务成功）奖励进行端到端强化学习。

Result: 实验表明，LUSTER系统在任务成功率和情感响应方面表现更优，为下一代对话系统提供了实用路径。

Conclusion: 结合LLM与结构化奖励模型能显著提升任务导向对话系统的鲁棒性和情感智能。
...
### [244] [Chart Question Answering from Real-World Analytical Narratives](https://arxiv.org/abs/2507.01627)
*Maeve Hutchinson,Radu Jianu,Aidan Slingsby,Jo Wood,Pranava Madhyastha*

Main category: cs.CL

TL;DR: 新数据集用于图表问答（CQA），基于可视化笔记本构建，包含真实世界的多视图图表和自然语言问题，反映实际推理流程。GPT-4.1准确率为69.3%，显示现有模型的挑战。
...
Conclusion: 新数据集为图表问答提供了更真实的评估环境，凸显了现有模型的局限性。
...
### [245] [Confidence and Stability of Global and Pairwise Scores in NLP Evaluation](https://arxiv.org/abs/2507.01633)
*Georgii Levtsov,Dmitry Ustalov*
...
<details>
  <summary>Details</summary>
Motivation: 随着指令调优神经语言模型的发展，NLP评估从全局评分转向成对比较。本文旨在比较两种方法的优劣，以帮助选择合适的评估策略。

Method: 通过合成和真实数据集的计算实验，使用全局指标和Bradley-Terry模型进行成对比较。

Result: 全局评分提供更可靠的总体排名，但可能低估某些模型；成对比较能更好识别低分模型中的强者，但需要更多比较次数。

Conclusion: 两种方法各有优劣，选择评估策略应根据具体需求和场景。
...
### [246] [Adapting Language Models to Indonesian Local Languages: An Empirical Study of Language Transferability on Zero-Shot Settings](https://arxiv.org/abs/2507.01645)
*Rifki Afina Putri*

Main category: cs.CL

TL;DR: 研究了预训练语言模型在低资源印尼本地语言情感分析任务中的迁移能力，发现多语言模型在已见语言上表现最佳，MAD-X适配器方法显著提升性能。


<details>
  <summary>Details</summary>
Motivation: 探索预训练语言模型在低资源印尼本地语言中的迁移能力，以情感分析为任务，填补相关研究空白。

Method: 评估了零样本和适配器迁移方法，使用印尼单语BERT、多语言模型（mBERT、XLM-R）及MAD-X适配器方法，并将目标语言分为已见、部分已见和未见三类。

Result: 多语言模型在已见语言上表现最好，MAD-X显著提升性能，尤其是已见和部分已见语言。语言模型的预训练暴露是迁移成功的关键因素。

Conclusion: 语言模型的预训练暴露是迁移性能的主要决定因素，MAD-X适配器方法有效提升低资源语言任务表现。
...
### [247] [AdamMeme: Adaptively Probe the Reasoning Capacity of Multimodal Large Language Models on Harmfulness](https://arxiv.org/abs/2507.01702)
*Zixin Chen,Hongzhan Lin,Kaixin Li,Ziyang Luo,Zhen Ye,Guang Chen,Zhiyong Huang,Jing Ma*
...
<details>
  <summary>Details</summary>
Motivation: 现有静态数据集评估方法无法适应模因的动态演变，需更灵活、全面的评估框架。

Method: 采用多智能体协作框架，动态更新模因数据以挑战mLLMs，揭示其局限性。

Result: 实验表明AdamMeme能系统性地分析不同mLLMs的性能差异，识别模型弱点。

Conclusion: AdamMeme为评估mLLMs在有害模因理解方面提供了动态、深入的解决方案。
...
### [248] [Stereotype Detection as a Catalyst for Enhanced Bias Detection: A Multi-Task Learning Approach](https://arxiv.org/abs/2507.01715)
*Aditya Tomar,Rudra Murthy,Pushpak Bhattacharyya*

Main category: cs.CL

TL;DR: 论文提出了一种联合学习偏见和刻板印象检测的方法，通过引入StereoBias数据集，验证了联合训练能显著提升偏见检测效果。
...
Method: 使用StereoBias数据集，比较了编码器模型和解码器模型（通过QLoRA微调），并验证联合训练的效果。

Result: 联合训练显著提升偏见检测效果，且解码器模型表现竞争力。情感分析实验证实改进源于偏见与刻板印象的关联。
...
### [249] [LLMs for Legal Subsumption in German Employment Contracts](https://arxiv.org/abs/2507.01734)
*Oliver Wardas,Florian Matthes*
...
Method: 与法律专家合作扩展数据集，利用LLM和上下文学习评估合同条款的合法性，比较不同法律上下文（无上下文、全文法律来源、精简版指南）对模型性能的影响。

Result: 全文法律来源对性能有适度提升，而精简版指南显著提高了无效条款的召回率和加权F1分数（达80%），但LLM表现仍远低于人类律师。

Conclusion: LLM在合同合法性审查中有潜力辅助律师，但现有方法仍有局限性；贡献了扩展数据集、代码和日志文件。
...
### [250] [Data interference: emojis, homoglyphs, and issues of data fidelity in corpora and their results](https://arxiv.org/abs/2507.01764)
*Matteo Di Cristofaro*

Main category: cs.CL

TL;DR: 论文探讨了分词对语言数据表示和分析结果的影响，强调预处理表情符号和同形异义词的必要性，并提出了确保数字文本在语料库中准确表示的方法。


<details>
  <summary>Details</summary>
Motivation: 分词是语料库语言学的基础步骤，但表情符号和同形异义词等特殊元素可能导致数据表示和分析结果的不一致，影响语料库的可靠性和分析的可重复性。

Method: 研究提出了预处理表情符号和同形异义词的方法，以确保数字文本在语料库中的准确表示。

Result: 研究强调了理解语言和技术细节对提高语料库分析准确性的重要性，并对定量和定性方法在语料库研究中的应用提出了重要启示。

Conclusion: 为确保语料库分析的可靠性和可重复性，必须对数字文本中的特殊元素进行预处理，并深入理解相关语言和技术问题。
...
### [251] [MuRating: A High Quality Data Selecting Approach to Multilingual Large Language Model Pretraining](https://arxiv.org/abs/2507.01785)
*Zhixun Chen,Ping Guo,Wenhan Han,Yifan Zhang,Binbin Liu,Haobin Lin,Fengze Liu,Yan Zhao,Bingni Zhang,Taifeng Wang,Yin Zheng,Meng Fang*
...
<details>
  <summary>Details</summary>
Motivation: 数据质量对大型语言模型性能至关重要，但现有方法主要集中于英语，缺乏多语言支持。

Method: MuRating通过聚合多个英语评分器的数据质量信号，学习统一的文档质量评分，并通过翻译将这些评分投射到目标语言，训练多语言评估器。

Result: 在1.2B参数的LLaMA模型上，MuRating在英语和多语言基准测试中均显著提升了准确性，尤其在知识密集型任务上表现突出。

Conclusion: MuRating在多语言数据质量评估中表现出色，同时指出了翻译保真度和叙事材料不足等未来研究方向。
...
### [252] [Probing Evaluation Awareness of Language Models](https://arxiv.org/abs/2507.01786)
*Jord Nguyen,Khiem Hoang,Carlo Leonardo Attubato,Felix Hofstätter*

Main category: cs.CL

TL;DR: 研究发现语言模型（如Llama-3.3-70B-Instruct）能区分测试与部署阶段，称为“评估意识”，这对AI安全评估的可靠性构成挑战。


<details>
  <summary>Details</summary>
Motivation: 探讨语言模型的评估意识及其对AI治理框架和行业自愿承诺的潜在影响。

Method: 使用线性探针分析模型内部表示，区分真实评估与部署提示。

Result: 线性探针能有效分离评估与部署提示，且当前安全评估被模型视为不真实。

Conclusion: 强调确保可信评估和了解模型欺骗能力的重要性，并展示模型内部信息在安全审计中的潜在用途。
...
### [253] [How Do Vision-Language Models Process Conflicting Information Across Modalities?](https://arxiv.org/abs/2507.01790)
*Tianze Hua,Tian Yun,Ellie Pavlick*

Main category: cs.CL

TL;DR: 研究探讨多模态AI模型在输入信息冲突时的行为，发现模型倾向于优先处理某一模态，并揭示其内部表征结构和注意力机制的作用。
...
Method: 通过向视觉-语言模型提供不一致的输入（如图像与标题矛盾），观察模型如何报告特定模态的信息，并分析其内部表征和注意力机制。

Result: 模型倾向于优先处理某一模态，且不同模型偏好不同；内部表征结构和特定注意力头可调整模态偏好；发现模态无关的“路由头”可优化性能。
...
### [254] [The Anatomy of Evidence: An Investigation Into Explainable ICD Coding](https://arxiv.org/abs/2507.01802)
*Katharina Beckh,Elisa Studeny,Sujan Sai Gannamaneni,Dario Antweiler,Stefan Rüping*
...
<details>
  <summary>Details</summary>
Motivation: 自动医疗编码可简化文档和计费流程，但缺乏透明度和评估数据，MDACE数据集为此提供了资源。
...
### [255] [Evaluating Structured Output Robustness of Small Language Models for Open Attribute-Value Extraction from Clinical Notes](https://arxiv.org/abs/2507.01810)
*Nikita Neveditsin,Pawan Lingras,Vijay Mago*

Main category: cs.CL

TL;DR: 比较了小型语言模型在临床笔记中生成结构化输出的可解析性，JSON表现最佳。


<details>
  <summary>Details</summary>
Motivation: 研究不同序列化格式（JSON、YAML、XML）在临床笔记中的解析性能，为隐私敏感的临床环境提供实用指导。

Method: 评估三种序列化格式的解析性，分析目标提示和模型大小的影响，并进行错误分析。

Result: JSON解析性最高，结构鲁棒性随提示优化和模型增大而提升，但对长文档和特定笔记类型表现下降。

Conclusion: JSON是临床笔记结构化输出的最佳选择，提示设计和模型大小需根据文档类型调整。
...
### [256] [Low-Perplexity LLM-Generated Sequences and Where To Find Them](https://arxiv.org/abs/2507.01844)
*Arthur Wuhrmann,Anastasiia Kucherenko,Andrei Kucharavy*
...
### [257] [Eka-Eval : A Comprehensive Evaluation Framework for Large Language Models in Indian Languages](https://arxiv.org/abs/2507.01853)
*Samridhi Raj Sinha,Rajvee Sheth,Abhishek Upperwal,Mayank Singh*
...
Method: EKA-EVAL整合了35个基准测试，支持分布式推理、量化和多GPU使用，提供端到端的评估解决方案。

Result: EKA-EVAL成为首个为全球和印度LLMs量身定制的可扩展评估套件，显著降低了多语言基准测试的门槛。

Conclusion: EKA-EVAL是开源的，旨在扩展至100多个基准测试，建立强大的多语言LLM评估生态系统。
...
### [258] [DIY-MKG: An LLM-Based Polyglot Language Learning System](https://arxiv.org/abs/2507.01872)
*Kenan Tang,Yanhong Li,Yao Qin*

Main category: cs.CL

TL;DR: DIY-MKG是一个支持多语言学习的开源系统，通过个性化词汇知识图谱和动态测验生成解决现有工具的局限性。
...
### [259] [MiCoTA: Bridging the Learnability Gap with Intermediate CoT and Teacher Assistants](https://arxiv.org/abs/2507.01887)
*Dongyi Ding,Tiannan Wang,Chenghao Zhu,Meiling Tao,Yuchen Eleanor Jiang,Wangchunshu Zhou*

Main category: cs.CL

TL;DR: MiCoTA框架通过中间规模模型作为教师助理，提升小语言模型的长链推理能力，显著提高下游任务表现。
...
Method: 引入MiCoTA框架，利用中间规模模型和中间长度推理序列，弥合容量和推理长度差距。

Result: Qwen2.5-7B和Qwen2.5-3B模型在多个基准测试中平均得分分别提升3.47和3.93。

Conclusion: MiCoTA通过优化数据分布，为SLMs的长链推理蒸馏提供了有效解决方案，并推动未来研究。
...
### [260] [High-Layer Attention Pruning with Rescaling](https://arxiv.org/abs/2507.01900)
*Songtao Liu,Peng Liu*

Main category: cs.CL

TL;DR: 提出一种新颖的剪枝算法，针对大语言模型的高层注意力头进行策略性剪枝，并通过自适应重缩放参数校准表示尺度，显著优于现有方法。
...
Result: 在27个数据集上的生成和判别任务中，性能优于现有剪枝方法，尤其在生成任务中表现突出。

Conclusion: 该方法有效提升剪枝后模型的性能，尤其在生成任务中优势显著。
...
### [261] [AI4Research: A Survey of Artificial Intelligence for Scientific Research](https://arxiv.org/abs/2507.01903)
*Qiguang Chen,Mingda Yang,Libo Qin,Jinhao Liu,Zheng Yan,Jiannan Guan,Dengyun Peng,Yiyan Ji,Hanjing Li,Mengkang Hu,Yimeng Zhang,Yihao Liang,Yuhang Zhou,Jiaqi Wang,Zhi Chen,Wanxiang Che*

Main category: cs.CL

TL;DR: 该论文对AI在科学研究中的应用（AI4Research）进行了全面综述，提出了系统分类法、指出了研究空白和未来方向，并整理了丰富的资源。


<details>
  <summary>Details</summary>
Motivation: 大型语言模型（LLMs）在逻辑推理和实验编码等复杂领域的显著能力激发了AI在科学研究中的应用探索，但缺乏全面综述阻碍了该领域的发展。

Method: 提出系统分类法对AI4Research的五类主流任务进行分类，识别研究空白并强调未来方向，同时整理多学科应用、数据和工具资源。

Result: 论文提供了AI4Research的系统分类、未来研究方向及丰富资源，为研究社区提供了快速访问和创新的基础。

Conclusion: 该综述填补了AI4Research领域的空白，为研究社区提供了统一视角和资源，有望推动该领域的创新突破。
...
### [262] [Gradient-Adaptive Policy Optimization: Towards Multi-Objective Alignment of Large Language Models](https://arxiv.org/abs/2507.01915)
*Chengao Li,Hanyu Zhang,Yunkun Xu,Hongyan Xue,Xiang Ao,Qing He*

Main category: cs.CL

TL;DR: GAPO是一种新的微调方法，通过多梯度下降解决LLM与多样化人类偏好的对齐问题，优于现有方法。
...
Conclusion: GAPO有效解决了多样化偏好对齐问题，性能优于现有技术。
...
TL;DR: 研究比较了Whisper和Wav2Vec-BERT在低资源语言Bangla上的表现，Wav2Vec-BERT在所有关键指标上表现更优。


<details>
  <summary>Details</summary>
Motivation: 评估低资源语言Bangla的自动语音识别（ASR）模型性能，为开发鲁棒的语音识别系统提供参考。

Method: 使用Mozilla Common Voice-17和OpenSLR数据集，通过微调和超参数优化比较Whisper和Wav2Vec-BERT的WER、CER、训练时间和计算效率。

Result: Wav2Vec-BERT在所有关键指标上优于Whisper，且计算资源需求更低。

Conclusion: Wav2Vec-BERT在低资源语言环境下表现更优，为开发高效ASR系统提供了重要参考。
...
### [264] [NaturalThoughts: Selecting and Distilling Reasoning Traces for General Reasoning Tasks](https://arxiv.org/abs/2507.01921)
*Yang Li,Youssef Emad,Karthik Padthe,Jack Lanchantin,Weizhe Yuan,Thao Nguyen,Jason Weston,Shang-Wen Li,Dong Wang,Ilia Kulikov,Xian Li*
...
<details>
  <summary>Details</summary>
Motivation: 研究教师模型的何种推理演示对学生模型最有效，以提升推理能力。

Method: 从教师模型中精选高质量推理轨迹（NaturalThoughts），分析影响蒸馏效果的因素，并评估其性能。

Result: NaturalThoughts在Llama和Qwen模型上表现优于现有数据集，尤其在STEM推理任务中。

Conclusion: 精选高质量推理轨迹（尤其是复杂示例）能更高效地提升学生模型的推理能力。
...
### [265] [Decision-oriented Text Evaluation](https://arxiv.org/abs/2507.01923)
*Yu-Shiang Huang,Chuan-Ju Wang,Chung-Chi Chen*

Main category: cs.CL

TL;DR: 提出了一种基于决策效果的文本生成评估框架，发现传统评估方法与实际决策效果相关性弱，而人机协作能显著提升决策质量。
...
Method: 通过市场摘要文本（客观晨报和主观收盘分析）测试生成文本对人类和LLM决策的影响，评估决策质量。

Result: 人类和LLM单独依赖摘要时表现不优于随机；但人机协作结合丰富分析评论能显著超越个体表现。
...
### [266] [The Thin Line Between Comprehension and Persuasion in LLMs](https://arxiv.org/abs/2507.01936)
*Adrian de Wynter,Tangming Yuan*
...
Result: LLMs能进行连贯且具说服力的辩论，但无法展示对深层对话结构的理解。

Conclusion: LLMs作为评估者的局限性源于其对上下文的理解不足，辩论能力不依赖于对话题的实际理解。
...
### [267] [Rethinking the Illusion of Thinking](https://arxiv.org/abs/2507.01231)
...
### [268] [Beyond Black-Box AI: Interpretable Hybrid Systems for Dementia Care](https://arxiv.org/abs/2507.01282)
...
### [269] [AI Agents and Agentic AI-Navigating a Plethora of Concepts for Future Manufacturing](https://arxiv.org/abs/2507.01376)
...
### [270] [A Fuzzy Approach to the Specification, Verification and Validation of Risk-Based Ethical Decision Making Models](https://arxiv.org/abs/2507.01410)
...
### [271] [Pensieve Grader: An AI-Powered, Ready-to-Use Platform for Effortless Handwritten STEM Grading](https://arxiv.org/abs/2507.01431)
...
### [272] [Using multi-agent architecture to mitigate the risk of LLM hallucinations](https://arxiv.org/abs/2507.01446)
...
### [273] [Agent-as-Tool: A Study on the Hierarchical Decision Making with Reinforcement Learning](https://arxiv.org/abs/2507.01489)
*Yanfei Zhang*
...
### [274] [T3DM: Test-Time Training-Guided Distribution Shift Modelling for Temporal Knowledge Graph Reasoning](https://arxiv.org/abs/2507.01597)
...
### [275] [Agent Ideate: A Framework for Product Idea Generation from Patents Using Agentic AI](https://arxiv.org/abs/2507.01717)
...
### [276] [Joint Matching and Pricing for Crowd-shipping with In-store Customers](https://arxiv.org/abs/2507.01749)
...
### [277] [Refining Gelfond Rationality Principle Towards More Comprehensive Foundational Principles for Answer Set Semantics](https://arxiv.org/abs/2507.01833)
...
### [278] [Rethinking the Illusion of Thinking](https://arxiv.org/abs/2507.01231)
*Iñaki Dellibarda Varela,Pablo Romero-Sorozabal,Eduardo Rocon,Manuel Cebrian*
...
Result: LRMs在复杂任务（如8个圆盘的Towers of Hanoi）中表现受限，但在可解问题（如100+代理对的River Crossing）中表现优异。

Conclusion: 当前LRMs是随机搜索器，真正的符号推理进展需要更精细的实验方法。
...
### [279] [Beyond Black-Box AI: Interpretable Hybrid Systems for Dementia Care](https://arxiv.org/abs/2507.01282)
*Matthew JY Kang,Wenli Yang,Monica R Roberts,Byeong Ho Kang,Charles B Malpas*

Main category: cs.AI

TL;DR: 本文探讨了大型语言模型（LLMs）在医疗诊断中的局限性，特别是在痴呆症诊断和护理中，强调需要结合统计学习和专家知识以提高透明度和实用性。


<details>
  <summary>Details</summary>
Motivation: 尽管LLMs在基准测试中表现优异，但在实际临床环境中未能显著提升诊断效果，因此需要研究其局限性并提出改进方向。

Method: 通过范围综述，分析了LLMs在临床实践中的不足，并提出了结合统计学习和专家知识的混合方法。

Result: 研究发现，纯数据驱动的LLMs缺乏透明度和因果推理能力，而混合方法（如PEIRS和ATHENA-CDS）更符合临床需求。

Conclusion: 未来AI决策支持应注重解释性和临床实用性，结合神经符号AI和人类因果知识，并关注临床工作流程和患者结果。
...
### [280] [AI Agents and Agentic AI-Navigating a Plethora of Concepts for Future Manufacturing](https://arxiv.org/abs/2507.01376)
*Yinwang Ren,Yangyang Liu,Tang Ji,Xun Xu*

Main category: cs.AI

TL;DR: 该论文综述了基于LLM和MLLM的AI代理及Agentic AI在智能制造中的潜力、挑战和应用。


<details>
  <summary>Details</summary>
Motivation: 探讨新兴AI范式（LLM-Agents、MLLM-Agents和Agentic AI）在智能制造中的定义、能力边界和实际应用，填补研究空白。

Method: 系统回顾AI和AI代理技术的发展，分析LLM-Agents、MLLM-Agents和Agentic AI的核心概念与技术进展，探索其在制造中的应用与挑战。

Result: LLM-Agents、MLLM-Agents和Agentic AI提升了语义理解、复杂推理和自主决策能力，为智能制造开辟新途径。

Conclusion: 研究明确了这些AI范式在智能制造中的潜力，但定义、能力边界和实际应用仍需进一步探索。
...
### [281] [A Fuzzy Approach to the Specification, Verification and Validation of Risk-Based Ethical Decision Making Models](https://arxiv.org/abs/2507.01410)
*Abeer Dyoub,Francesca A. Lisi*

Main category: cs.AI

TL;DR: 提出了一种基于伦理风险评估的模糊规则模型，用于描述和验证道德决策，并通过医疗案例验证其有效性。


<details>
  <summary>Details</summary>
Motivation: 道德领域的复杂性和模糊性使得评估道德机器的性能标准难以明确，因此需要一种形式化方法来描述和验证道德决策模型。

Method: 使用模糊规则描述伦理决策模型，并通过模糊Petri网进行验证和验证。

Result: 通过医疗领域的案例研究验证了所提方法的可行性和有效性。

Conclusion: 该方法为道德机器的伦理决策提供了一种可验证的形式化框架。
...
### [282] [Pensieve Grader: An AI-Powered, Ready-to-Use Platform for Effortless Handwritten STEM Grading](https://arxiv.org/abs/2507.01431)
*Yoonseok Yang,Minjune Kim,Marlon Rondinelli,Keren Shao*
...
Result: 在20多所机构中部署，评分超过30万份答案，评分时间减少65%，高置信度预测与教师评分一致率达95.4%。
...
### [283] [Using multi-agent architecture to mitigate the risk of LLM hallucinations](https://arxiv.org/abs/2507.01446)
*Abd Elrahman Amer,Magdi Amer*

Main category: cs.AI

TL;DR: 提出多智能体系统结合模糊逻辑和LLM，以减少幻觉风险，提升客户服务质量。


<details>
  <summary>Details</summary>
Motivation: 提高客户服务质量和响应时间，维持客户忠诚度并增加市场份额。

Method: 集成基于LLM的智能体与模糊逻辑，处理客户短信请求。

Result: 通过模糊逻辑减少LLM的幻觉风险。

Conclusion: 多智能体系统有效提升客户服务质量并降低技术风险。
...
### [284] [Agent-as-Tool: A Study on the Hierarchical Decision Making with Reinforcement Learning](https://arxiv.org/abs/2507.01489)
*Yanfei Zhang*
...
Conclusion: Agent-as-tool框架有效减轻模型负担，提升推理能力，性能优于现有方法。
...
### [285] [T3DM: Test-Time Training-Guided Distribution Shift Modelling for Temporal Knowledge Graph Reasoning](https://arxiv.org/abs/2507.01597)
*Yuehang Si,Zefan Zeng,Jincai Huang,Qing Cheng*

Main category: cs.AI

TL;DR: 论文提出了一种新的TKG推理方法T3DM，通过分布特征建模和对抗训练生成高质量负样本，解决了训练与测试样本分布偏移和低质量负样本的问题。


<details>
  <summary>Details</summary>
Motivation: 现有TKG推理方法在建模训练与测试样本分布偏移和生成高质量负样本方面存在不足。

Method: 提出T3DM方法，通过分布特征建模调整模型，并设计基于对抗训练的负采样策略。

Result: 实验表明T3DM在多数情况下优于现有基线方法，结果更优且更稳健。

Conclusion: T3DM通过分布建模和高质量负采样，显著提升了TKG推理的性能和鲁棒性。
...
### [286] [Agent Ideate: A Framework for Product Idea Generation from Patents Using Agentic AI](https://arxiv.org/abs/2507.01717)
*Gopichand Kanumolu,Ashok Urlana,Charaka Vinayak Kumar,Bala Mallikarjunarao Garlapati*

Main category: cs.AI

TL;DR: 利用大型语言模型（LLMs）和自主代理从专利中挖掘并生成产品概念，提出Agent Ideate框架，实验证明代理方法在创意质量、相关性和新颖性上优于独立LLMs。
...
### [287] [Joint Matching and Pricing for Crowd-shipping with In-store Customers](https://arxiv.org/abs/2507.01749)
*Arash Dehghan,Mucahit Cevik,Merve Bodur,Bissan Ghaddar*

Main category: cs.AI

TL;DR: 论文研究了利用店内顾客作为配送员的集中式众包配送系统，提出了一种结合NeurADP和DDQN的动态优化策略，显著提高了配送效率并降低了成本。


<details>
  <summary>Details</summary>
Motivation: 针对城市地区最后一公里配送效率的需求增长，探索利用现有店内顾客资源进行配送的可行性。

Method: 提出了一个马尔可夫决策过程（MDP）模型，结合NeurADP和DDQN进行动态订单分配和定价优化。

Result: 实验结果显示，该方法比固定定价策略节省6.7%的成本，比短视基线节省约18%，灵活配送和多目的地路由进一步降低成本。
...
### [288] [Refining Gelfond Rationality Principle Towards More Comprehensive Foundational Principles for Answer Set Semantics](https://arxiv.org/abs/2507.01833)
*Yi-Dong Shen,Thomas Eiter*

Main category: cs.AI

TL;DR: 论文探讨了非单调逻辑编程中回答集语义的一般原则，提出了对Gelfond回答集原则的细化，并定义了新的语义。


<details>
  <summary>Details</summary>
Motivation: 研究回答集语义的一般原则，探讨是否必须满足最小模型属性、约束单调性和基础性，并提出替代原则。

Method: 细化Gelfond回答集原则，包括良好支持性、默认否定最小性和认知否定最小性，并定义新的语义。

Result: 提出新的回答集语义，并基于细化原则评估现有语义。

Conclusion: 细化后的GAS原则为回答集语义提供了更灵活和合理的基础。
